...
{"0": {
    ...
    "content": "The instructions in this tutorial assume that you have already installed following software. | MPLAB X Integrated Development Environment | MPLAB XC32/32++ C Compiler | . ",
    ...
    "doc": "Create First Harmony 3 Project",
    "title": "Procedure",
    "content": "The following are the steps to create, generate, build and flash LED Blinking application. Before proceeding, make sure you have downloaded the required Harmony 3 packages (for directions, the MPLAB® Code Configurator (MCC) User’s Guide) and setup the required hardware as shown previously. ",
    ...
    "content": ". | Open the MPLAB® X IDE. | Create a New Project by clicking the New Project icon or by selecting File &gt; New Project. | In the New Project window select Application Project(s). | Click Next. Note: . | If the option 32-Bit MPLAB Harmony v3 Project is not available, install the MPLAB® Harmony 3 Launcher plug-in from Tools &gt; Plugins &gt; Available Plugins before continuing with this demonstration. | If the Harmony Content Path and Repository is not set, then go to Tools &gt; Options, select Pugins and select the Harmony Repository and enter the your Harmony Content Path as shown in the below figure to download the Harmony packages. | . | In the Select Device dialog window, select the target Device ATSAMC21N18A from the drop-down menu as shown below and Click Next. | In the Select Compiler dialog window, select the latest or needed Compiler as follows: . | Click Next. | . | In the Select Project Name and Folder dialog window, fill in or select the information needed as follows: . | Project Name: Project naame i.e. “sam_c21n_xpro” | Project Location: Select or Enter the Project Location of your choice. | For Example: MyProject_blink and the Project Location is: . | C:/Users/&lt;user_id&gt;/MPLABXProjects/sam_c21n/MyProject_blink/firmware | . | Note: Kindly suffix the firmware folder name after the Project folder “MyProject_blink”. | . | Project Folder: This is a read-only field, MCC automatically creates the .X project folder in the above mentioned project location. | . | Click Finish. | Download the Required Mandatory Harmony Content if not downloaded. | The below MCC Content Manager window will open if the Mandatory Harmony Contents are not present in the Harmony Content Path mentioned in the Step 4. | Click on the Finish Button in the MCC Content Manager Wizard to start downloading the Mandatory Harmony Content. | Note: For this demonstration application, the following MPLAB Harmony v3 packages are required: csp, harmony-services, CMSIS, and quick_docs. The MPLAB Harmony 3 Content Manager tool simplifies the downloading of the MPLAB Harmony v3 packages. If these packages are not downloaded, then the user can use the MPLAB Harmony 3 Content Manager tool to download them onto their computer. | If you need you can select the optional contents like bsp, core, CMSIS-FreeRTOS, etc and click apply, then Content Manager will start downloading these selected packages under the Harmony Content path. | Similarly, update the MCC Core Versions to the latest if not already updated. | . | . | . ",
    ...
    "content": ". | Click on the Resource Management [MCC] tab, In the Device Resources , expand Harmony &gt; Peripherals &gt; TC. Select and double click on TC0 to add the TC0 to the project. | Click on the “TC0” component and configure as below and in the figure: . | Select Prescaler value to “Prescaler: GCLK_TC/1024” | Set Time (Milli Sec) to “500” | . This will toggle the LED every 0.5 seconds, producing a LED blink every second. | Launch the Pin Configuration manager by clicking Project Graph &gt; Plugins &gt; Pin Configuration. | Setup pin “PC05” as the board’s LED, set custom name as “LED” and Direction as “Out”: . This is necessary because the project doesn’t use a Board Support Package (BSP). | Generate the application’s code for the first time. | Generate the code by using MCC. From the left side tab, Resource Management [MCC], go to Project Resources and click on the Generate button. | Note: . | You can open the Content Manager anytime and download/rebase the Harmony packages by clicking the Content Manager under the Device Resources tab as shown below. | . | . | Let’s examine the software just created in the Projects panel of MPLAB® X IDE Header Files are shown on the top and Source Files are shown on the bottom. Note: The icons used in this picture of the project’s organization make it seem like the files of the project are organized this way on disk. In fact, this is a virtual organization of these files, not an actual one. On disk, the source and header files are not separated. The following table describes the Header and Source files generated from the sample project: . | # | Source File | Descriptions | . | 1 | definitions.h | Provides configuration-specific definitions | . | 2 | exceptions.c | Implements exception handlers | . | 3 | initialization.c | Implements SYS_Initialize to initializes all libraries and applications | . | 4 | interrupts.c | Implements the interrupt vectors | . | 5 | peripheral [libraries] | Implements peripheral libraries used by the project | . | 6 | startup.c | Startup code for the application | . If you click on the Projects tab you will see the actual organization of these files on your drive: . | . ",
    ...
    "doc": "Create First Harmony 3 Project",
    "title": "Note",
    "content": "This page has been verified with the following versions of software tools: . | MPLAB X IDE v6.20 | MPLAB XC32 Compiler v4.40 | MPLAB Code Configurator Plugin v5.5.1 | MPLAB Harmony v3 “csp” repo v3.18.5 | . Because Microchip regularly update tools, occasionally there could be minor differences with the newer versions of the tools. ",
    ...
    "doc": "Create First Harmony 3 Project",
    "title": "References",
    "content": ". | SAMC21N Xplained Pro Evaluation Kit User Guide and Datasheet | MPLAB X IDE User’s Guide . | User’s Guide direct download | . | How to Set up the Tools Required to Get Started with MPLAB® Harmony v3 and MCC | MPLAB Harmony 3 Content Manager | . ",
    ...
    "doc": "Create a first application on PIC32CM JH01 Microcontrollers using MPLAB Harmony v3 with using MCC",
    "title": "Create a first application on PIC32CM JH01 Microcontrollers using MPLAB Harmony v3 with MCC",
    "content": "The PIC32CM JH family of microcontrollers (MCUs) is the next generation of the popular SAM C21 family of Arm® Cortex®-M0+ based MCUs. The PIC32CM JH family of MCUs delivers a variety of popular features plus extended memory options up to 512 KB of Flash and 64 KB to help create designs that need functional safety, enhanced touch, or security. This family pin is compatible with the SAM C21 family in the 32-pin, 48-pin and 64-pin packages. The application makes use of PIC32CM JH01 Curiosity Pro Evaluation Kit. This tutorial explains how to create a simple application on a Cortex-M0+ based PIC32CM JH01 Microcontroller using the MPLAB Code Configurator (MCC) with MPLAB Harmony v3 modules. The objective of this application is to toggle an LED on a timeout basis and print the LED toggling rate. For this demonstration, the following MPLAB Harmony v3 modules are used and configured using the MCC. The applications you create will utilize: . | The PORT pin to toggle LED. | Real-Time Clock (RTC) PLIB to periodically sample LED toggling rate. | External Interrupt Controller (EIC) PLIB to change the toggling rate when there is a switch press event. | Serial Communication Interfaces (SERCOM (SERCOM configured as USART)) and DMA PLIBs to print LED toggling rate on COM port terminal application (Serial Console) running on a computer. | . For more information refer the links below. ",
    "url": "http://localhost:4000/quick_docs/source/basic/create_first_harmony_3_project_pic32cm_jh01/readme.html#create-a-first-application-on-pic32cm-jh01-microcontrollers-using-mplab-harmony-v3-with-mcc",
    "relUrl": "/source/basic/create_first_harmony_3_project_pic32cm_jh01/readme.html#create-a-first-application-on-pic32cm-jh01-microcontrollers-using-mplab-harmony-v3-with-mcc"
  },"23": {
    "doc": "Create a first application on PIC32CM JH01 Microcontrollers using MPLAB Harmony v3 with using MCC",
    "title": " ",
    "content": " ",
    "url": "http://localhost:4000/quick_docs/source/basic/create_first_harmony_3_project_pic32cm_jh01/readme.html",
    "relUrl": "/source/basic/create_first_harmony_3_project_pic32cm_jh01/readme.html"
  },"24": {
    "doc": "Create a first application on PIC32CM JH01 Microcontrollers using MPLAB Harmony v3 with using MCC",
    "title": "Web Links",
    "content": ". | Creating the First Application on PIC32CM JH01 Microcontrollers Using MPLAB Harmony v3 with MPLAB Code Configurator (MCC) | . ",
    "url": "http://localhost:4000/quick_docs/source/basic/create_first_harmony_3_project_pic32cm_jh01/readme.html#web-links",
    "relUrl": "/source/basic/create_first_harmony_3_project_pic32cm_jh01/readme.html#web-links"
  },"25": {
    "doc": "Create a first application on PIC32CM JH01 Microcontrollers using MPLAB Harmony v3 with using MCC",
    "title": "Reference Links",
    "content": "                . ",
    "url": "http://localhost:4000/quick_docs/source/basic/create_first_harmony_3_project_pic32cm_jh01/readme.html#reference-links",
    "relUrl": "/source/basic/create_first_harmony_3_project_pic32cm_jh01/readme.html#reference-links"
  },"26": {
    "doc": "Create a first application on PIC32CM JH01 Microcontrollers using MPLAB Harmony v3 with using MCC",
    ...
    "doc": "Create a first application on PIC32CM LSx Microcontrollers using MPLAB Harmony v3 with using MCC",
    "title": "Create a first application on PIC32CM LSx Microcontrollers using MPLAB Harmony v3 with MCC",
    "content": "This document describes how to create a simple application on an Arm® Cortex®-M23 based PIC32CM LSx Microcontroller using the MPLAB Code Configurator (MCC) with MPLAB Harmony v3 modules. This application demonstrates the TrustZone®-based security feature on PIC32CM LSx Microcontrollers. The application consists of two projects which details about Secure and Non-Secure modes on PIC32CM LSx Microcontrollers. These two projects offer security isolation between the trusted and non-trusted resources in the device. The objective of this application is to toggle an LED on a timeout basis and print the LED toggling rate on the Serial Console. For this demonstration, the following MPLAB Harmony v3 modules are used and configured using the MCC as Secure and Non-Secure. The application makes use of PIC32CM LS60 Curiosity Pro Evaluation Kit. The applications you create will utilize: . | Secure PORT Pin to toggle LED (by default, all the PORT pins are configured as Secure). | Secure Real-Time Clock (RTC) PLIB to periodically sample LED toggling rate. | Secure External Interrupt Controller (EIC) PLIB to change the toggling rate when a switch press event occurs. The Non-Secure modules include: | Non-Secure SERCOM (configured as USART) and Non-Secure Direct Memory Access (DMA) PLIBs to print the LED toggling rate on a COM (serial) port terminal application running on a PC. | Non-Secure Port Pins (USART pins are responsible for printing the data on the Terminal after obtaining the values from Secure Application) to communicate with the Serial Terminal. | . For more information refer the links below. ",
    "url": "http://localhost:4000/quick_docs/source/basic/create_first_harmony_3_project_pic32cm_lsx/readme.html#create-a-first-application-on-pic32cm-lsx-microcontrollers-using-mplab-harmony-v3-with-mcc",
    "relUrl": "/source/basic/create_first_harmony_3_project_pic32cm_lsx/readme.html#create-a-first-application-on-pic32cm-lsx-microcontrollers-using-mplab-harmony-v3-with-mcc"
  },"28": {
    "doc": "Create a first application on PIC32CM LSx Microcontrollers using MPLAB Harmony v3 with using MCC",
    "title": " ",
    "content": " ",
    "url": "http://localhost:4000/quick_docs/source/basic/create_first_harmony_3_project_pic32cm_lsx/readme.html",
    "relUrl": "/source/basic/create_first_harmony_3_project_pic32cm_lsx/readme.html"
  },"29": {
    "doc": "Create a first application on PIC32CM LSx Microcontrollers using MPLAB Harmony v3 with using MCC",
    "title": "Web Links",
    "content": ". | Creating the First Application on PIC32CM LSx Microcontrollers Using MPLAB Harmony v3 with MPLAB Code Configurator (MCC) | . ",
    "url": "http://localhost:4000/quick_docs/source/basic/create_first_harmony_3_project_pic32cm_lsx/readme.html#web-links",
    "relUrl": "/source/basic/create_first_harmony_3_project_pic32cm_lsx/readme.html#web-links"
  },"30": {
    "doc": "Create a first application on PIC32CM LSx Microcontrollers using MPLAB Harmony v3 with using MCC",
    "title": "Reference Links",
    "content": "                . ",
    "url": "http://localhost:4000/quick_docs/source/basic/create_first_harmony_3_project_pic32cm_lsx/readme.html#reference-links",
    "relUrl": "/source/basic/create_first_harmony_3_project_pic32cm_lsx/readme.html#reference-links"
  },"31": {
    "doc": "Create a first application on PIC32CM LSx Microcontrollers using MPLAB Harmony v3 with using MCC",
    ...
    "doc": "Create a first application on PIC32CX SG Microcontrollers using MPLAB Harmony v3 with using MCC",
    "title": "Create a first application on PIC32CX SG Microcontrollers using MPLAB Harmony v3 with MCC",
    "content": "This tutorial explains how to create a simple application on a Arm® Cortex-M4F based PIC32CX SG Microcontroller using the MPLAB Code Configurator (MCC) with MPLAB Harmony v3 modules. The objective of this Application is to toggle an LED on a timeout basis and print the LED toggling rate and temperature reading periodically on a serial console. For this demonstration, the following MPLAB Harmony v3 modules are used and configured using the MCC: . The application makes use of PIC32CX SG61 Curiosity Ultra Evaluation Board. The objective of this application is to toggle an LED on a timeout basis and print the LED toggling rate on the serial console. For this demonstration, the following MPLAB Harmony v3 modules are used and configured using the MCC. The applications you create will utilize: . | The PORT pin to toggle the LED. | Real-Time Clock (RTC) PLIB to periodically sample the LED toggling rate and temperature reading. | Two instances of the External Interrupt Controller (EIC) PLIB: one to change the toggling rate when there is a switch press event and another one to decide what needs to be printed on the Serial Console; temperature reading or LED toggling rate. | SERCOM (configured as I2C) PLIB to read the temperature from an on-board temperature sensor. | SERCOM (configured as USART) and DMA PLIBs to print the LED toggling rate and temperature reading on a COM (serial console) port terminal application running on a PC. | . For more information refer the links below. ",
    "url": "http://localhost:4000/quick_docs/source/basic/create_first_harmony_3_project_pic32cx_sg/readme.html#create-a-first-application-on-pic32cx-sg-microcontrollers-using-mplab-harmony-v3-with-mcc",
    "relUrl": "/source/basic/create_first_harmony_3_project_pic32cx_sg/readme.html#create-a-first-application-on-pic32cx-sg-microcontrollers-using-mplab-harmony-v3-with-mcc"
  },"33": {
    "doc": "Create a first application on PIC32CX SG Microcontrollers using MPLAB Harmony v3 with using MCC",
    "title": " ",
    "content": " ",
    "url": "http://localhost:4000/quick_docs/source/basic/create_first_harmony_3_project_pic32cx_sg/readme.html",
    "relUrl": "/source/basic/create_first_harmony_3_project_pic32cx_sg/readme.html"
  },"34": {
    "doc": "Create a first application on PIC32CX SG Microcontrollers using MPLAB Harmony v3 with using MCC",
    "title": "Web Links",
    "content": ". | Creating the First Application on PIC32CX SG Microcontrollers Using MPLAB Harmony v3 with MPLAB Code Configurator (MCC) | . ",
    "url": "http://localhost:4000/quick_docs/source/basic/create_first_harmony_3_project_pic32cx_sg/readme.html#web-links",
    "relUrl": "/source/basic/create_first_harmony_3_project_pic32cx_sg/readme.html#web-links"
  },"35": {
    "doc": "Create a first application on PIC32CX SG Microcontrollers using MPLAB Harmony v3 with using MCC",
    "title": "Reference Links",
    "content": "                . ",
    "url": "http://localhost:4000/quick_docs/source/basic/create_first_harmony_3_project_pic32cx_sg/readme.html#reference-links",
    "relUrl": "/source/basic/create_first_harmony_3_project_pic32cx_sg/readme.html#reference-links"
  },"36": {
    "doc": "Create a first application on PIC32CX SG Microcontrollers using MPLAB Harmony v3 with using MCC",
    ...
    "doc": "Create a first application on PIC32CZ CAx Microcontrollers using MPLAB Harmony v3 with using MCC",
    "title": "Create a first application on PIC32CZ CAx Microcontrollers using MPLAB Harmony v3 with MCC",
    "content": "This tutorial explains how to create a simple application on an Arm® Cortex®-M7 based PIC32CZ CAx Microcontroller using the MPLAB Code Configurator (MCC) with MPLAB Harmony v3 modules. This technical brief used PIC32CZ CAx MCUs to create an application that gets you started in developing applications using MCC on the MPLAB Harmony v3 software framework. The application makes use of PIC32CZ CA90 Curiosity Ultra Development Board. Note: Though this application uses the PIC32CZ CAx microcontroller as an example, the general description and steps to install, configure, and generate code using MCC applies to all 32-bit PIC and SAM microcontrollers. The objective of this application is to toggle an LED on a timeout basis and print the LED toggling rate on the serial console. For this demonstration, the following MPLAB Harmony v3 modules are used and configured using the MCC. The applications you create will utilize: . | PORT Pin to toggle LED0. | Real-Time Clock (RTC) PLIB to periodically sample the LED0 toggling rate. | External Interrupt Controller (EIC) PLIB to change the toggling rate when there is a switch press event. | Serial Communication Interfaces ((SERCOM) configured as USART) and Direct Memory Access (DMA) PLIBs to print the LED0 toggling rate on a COM (serial) port terminal application running on a PC. | Port Pins (USART pins as they are responsible for printing the data on the terminal after obtaining the values) to communicate with the serial terminal. | . For more information refer the links below. ",
    "url": "http://localhost:4000/quick_docs/source/basic/create_first_harmony_3_project_pic32cz_cax/readme.html#create-a-first-application-on-pic32cz-cax-microcontrollers-using-mplab-harmony-v3-with-mcc",
    "relUrl": "/source/basic/create_first_harmony_3_project_pic32cz_cax/readme.html#create-a-first-application-on-pic32cz-cax-microcontrollers-using-mplab-harmony-v3-with-mcc"
  },"38": {
    "doc": "Create a first application on PIC32CZ CAx Microcontrollers using MPLAB Harmony v3 with using MCC",
    "title": " ",
    "content": " ",
    "url": "http://localhost:4000/quick_docs/source/basic/create_first_harmony_3_project_pic32cz_cax/readme.html",
    "relUrl": "/source/basic/create_first_harmony_3_project_pic32cz_cax/readme.html"
  },"39": {
    "doc": "Create a first application on PIC32CZ CAx Microcontrollers using MPLAB Harmony v3 with using MCC",
    "title": "Web Links",
    "content": ". | Creating the First Application on PIC32CZ CAx Microcontrollers Using MPLAB Harmony v3 with MPLAB Code Configurator (MCC) | . ",
    "url": "http://localhost:4000/quick_docs/source/basic/create_first_harmony_3_project_pic32cz_cax/readme.html#web-links",
    "relUrl": "/source/basic/create_first_harmony_3_project_pic32cz_cax/readme.html#web-links"
  },"40": {
    "doc": "Create a first application on PIC32CZ CAx Microcontrollers using MPLAB Harmony v3 with using MCC",
    "title": "Reference Links",
    "content": "                . ",
    "url": "http://localhost:4000/quick_docs/source/basic/create_first_harmony_3_project_pic32cz_cax/readme.html#reference-links",
    "relUrl": "/source/basic/create_first_harmony_3_project_pic32cz_cax/readme.html#reference-links"
  },"41": {
    "doc": "Create a first application on PIC32CZ CAx Microcontrollers using MPLAB Harmony v3 with using MCC",
    ...
    "doc": "Create Hello World application on SAM MCUs",
    "title": "Procedure",
    "content": "Step 1: To create an MPLAB Harmony v3-based project, follow these steps: . The following are the steps to create, generate, build and flash LED Blinking application. Before proceeding, make sure you have downloaded the required Harmony 3 packages (for directions, the MPLAB® Code Configurator (MCC) User’s Guide) and setup the required hardware as shown previously. ",
    ...
    "doc": "Create Hello World application on SAM MCUs",
    "title": "Create a new project",
    "content": ". | Open the MPLAB® X IDE. | Create a New Project by clicking the New Project icon or by selecting File &gt; New Project. | In the New Project window select Application Project(s). | Click Next. Note: . | If the option 32-Bit MPLAB Harmony v3 Project is not available, install the MPLAB® Harmony 3 Launcher plug-in from Tools &gt; Plugins &gt; Available Plugins before continuing with this demonstration. | If the Harmony Content Path and Repository is not set, then go to Tools &gt; Options, select Pugins and select the Harmony Repository and enter the your Harmony Content Path as shown in the below figure to download the Harmony packages. | . | In the Select Device dialog window, select the target Device ATSAMD21J18A from the drop-down menu as shown below and Click Next. | In the Select Compiler dialog window, select the latest or needed Compiler as follows: . | Click Next. | . | In the Select Project Name and Folder dialog window, fill in or select the information needed as follows: . | Project Name: Project naame i.e. “sam_d21_xpro” | Project Location: Select or Enter the Project Location of your choice. | For Example: sam_d21_hello and the Project Location is: . | C:/Users/&lt;user_id&gt;/MPLABXProjects/sam_device/sam_d21_01/firmware | . | Note: Kindly suffix the firmware folder name after the Project folder “sam_d21_01”. | . | Project Folder: This is a read-only field, MCC automatically creates the .X project folder in the above mentioned project location. | . | Click Finish. | Download the Required Mandatory Harmony Content if not downloaded. | The below MCC Content Manager window will open if the Mandatory Harmony Contents are not present in the Harmony Content Path mentioned in the Step 4. | Click on the Finish Button in the MCC Content Manager Wizard to start downloading the Mandatory Harmony Content. | Note: For this demonstration application, the following MPLAB Harmony v3 packages are required: csp, harmony-services, CMSIS, and quick_docs. The MPLAB Harmony 3 Content Manager tool simplifies the downloading of the MPLAB Harmony v3 packages. If these packages are not downloaded, then the user can use the MPLAB Harmony 3 Content Manager tool to download them onto their computer. | If you need you can select the optional contents like bsp, core, CMSIS-FreeRTOS, etc and click apply, then Content Manager will start downloading these selected packages under the Harmony Content path. | Similarly, update the MCC Core Versions to the latest if not already updated. | . | . | The MCC plug-in will open in a new window. The image below highlights different section available in the MCC. | . | . Step 2: To add and configure the MPLAB Harmony components using the MCC, follow these steps: . | Launch the Clock Configuration manager by clicking Project Graph &gt; Plugins &gt; Clock Configuration. The Clock Easy View window will be displayed inside the MCC Window. | In the Clock Easy View window, scroll to the right and verify that the Main Clock is set to 48 MHz. | To add and configure the USART Peripheral Library follow these steps: . | Click on the Resource Management [MCC] tab, In the Device Resources , expand Harmony &gt; Peripherals &gt; SERCOM. | Double-click on the SERCOM3 to add it to the project | . | Select the SERCOM3 Peripheral Library in the Project Graph, and in the Configuration Options window, configure it as follows: . | SERCOM Operation mode is set for USART with Internal Clock (default setting). | Clear Receive Enable, as the string will only be transmitted in this example. | Set the Baud Rate to 9600. | For Transmit Pinout choose SERCOM PAD[0] (default setting). | By default, the Receive Pinout is SERCOM PAD[0]. If the Receive Pinout feature is disabled, it will not affect the operation. | . | Configure the USART pin in the Pin Settings: In the MCC, select Project Graph &gt; Plugins &gt; Pin Configuration to open the Pin Settings window. | The MCC Pin Settings window will open and display these options: Pin Diagram, Pin Table, and Pin Settings. Note: According to the schematic of the SAMD21 Xplained Pro board, the on-board Embedded Debugger (EDBG) can be used as Virtual Com Port to have serial communication between the SAMD21 device and a connected computer console. Therefore, the PA22 (Pin #43) of the SAMD21 must be configured as USART_TX (SERCOM3 PAD0). | Click the Pin Settings tab and configure the PA22 pin as SERCOM3_PAD0. | The same pin (PA22) can be configured by clicking the Pin Table tab. Note: . | The USART_TX function (Transmit Pinout) is by default configured to be on SERCOM3 PAD0, for additional information, refer to MCC SERCOM Configuration. | In the SERCOM3 USART configuration, the USART is enabled only for transmit functionality. Therefore, the USART receive pin is not configured. | . | . Step 3: To generate the code, follow these steps: . | Generate the code by using MCC. From the left side tab, Resource Management (MCC), go to Project Resources and click on the Generate button. | The above step triggers these actions in MCC: . | Generate the code as per the configurations done. | Place the generated code and required MPLAB Harmony framework files in the MPLAB Harmony project directory, in this case: *C:/Users//MPLABXProjects/sam_device/sam_d21_01/firmware/src*. | Add all generated codes and MPLAB Harmony framework files into the MPLAB Harmony project, as shown in the following figure. | . Note: The MPLAB Harmony project will be shown in another window as this project is in Standalone mode. | The generated code descriptions are as follows: . | definitions.h: Includes all the header files required for the project. | initialization.c: Initializes all the MPLAB Harmony modules used in the application. | interrupts.c: Contains the mapping of all the interrupt vectors on the selected device. | main.c: A function call to initialize the system present in this file. The user needs to develop their application in this file. | peripheral: All peripheral source codes are added in this folder. | . Note: The MCC provides an option to change the generated file name, and if this option is not used, by default, the file name main.c is generated. | . Step 4: To develop and run an application, follow these steps: . | Developing an application: For this demo application, add the highlighted codes (as shown in image below) in the main.c file. This will send the “Hello World!” string to the console running on the PC. The following code is provided for convenience: . uint8_t buffer[]= \\\"Hello World!\\r\\n\\\"; SERCOM3_USART_Write(&amp;buffer[0], sizeof(buffer)); . | Selecting Hardware Tool and Compiler: In the MPLAB X IDE Project Properties window perform these actions: | Under Categories section, select Conf: (sam_d21_xpro), and in the Configuration section, select the hardware tool and compiler toolchain. | Click OK. | Connecting Hardware: Connect a micro-USB cable between the DEBUG USB on the board and the PC. This enables the programming of the microcontroller and provide a serial connection with the console device (computer). | Setting up the Serial Console: Open a terminal application, such as Tera Term on the PC and perform the serial port setup. Below is the default setup details for Tera Term. | Programing and Running the Application: Build and program the SAMD21 Xplained Pro kit by using the MPLAB X IDE. | Observing the Output: Observe the “Hello World!” string on the console. If the desired output is not found on the console, press the Reset button on the Xplained Pro board to reset the device, and ensure that the UART message is communicated. | . ",
    "url": "http://localhost:4000/quick_docs/source/basic/create_hello_world_sam_mcus/readme.html#create-a-new-project",
    "relUrl": "/source/basic/create_hello_world_sam_mcus/readme.html#create-a-new-project"
  },"56": {
    "doc": "Create Hello World application on SAM MCUs",
    "title": "Note",
    "content": "This page has been verified with the following versions of software tools: . | MPLAB X IDE v6.20 | MPLAB XC32 Compiler v4.40 | MPLAB Code Configurator Plugin v5.5.1 | MPLAB Harmony v3 “csp” repo v3.18.5 | . Because Microchip regularly update tools, occasionally there could be minor differences with the newer versions of the tools. ",
    ...
    "doc": "Create IAR or Keil project using MCC",
    "title": "Creating an IAR or KEIL project using MCC",
    "content": "When creating projects for IAR or KEIL IDEs, MCC is launched as an application (as opposed to a plugin in MPLAB® X, when creating MPLAB® X projects). We refer to this mode of operation of MCC as “standalone” throughout this document. Follow the steps detailed below to create an project for IAR or KEIL using MCC Standalone. ",
    "url": "http://localhost:4000/quick_docs/source/basic/create_iar_or_keil_project_using_mcc/readme.html#creating-an-iar-or-keil-project-using-mcc",
    "relUrl": "/source/basic/create_iar_or_keil_project_using_mcc/readme.html#creating-an-iar-or-keil-project-using-mcc"
  },"60": {
    "doc": "Create IAR or Keil project using MCC",
    "title": "Installing the MPLAB Code Configurator (MCC) Standalone",
    "content": ". | Goto the MPLAB Code Configurator (MCC) webpage and download the MCC Standalone version for the respective operating system. | Download the MCC Standalone from here. | . | . ",
    "url": "http://localhost:4000/quick_docs/source/basic/create_iar_or_keil_project_using_mcc/readme.html#installing-the-mplab-code-configurator-mcc-standalone",
    "relUrl": "/source/basic/create_iar_or_keil_project_using_mcc/readme.html#installing-the-mplab-code-configurator-mcc-standalone"
  },"61": {
    "doc": "Create IAR or Keil project using MCC",
    "title": "Launching MCC Standalone",
    "content": ". | Launch the MPLAB Code Configurator (MCC) Standalone application from the Start Menu. | It will appears as a separate application as below: | . | . ",
    "url": "http://localhost:4000/quick_docs/source/basic/create_iar_or_keil_project_using_mcc/readme.html#launching-mcc-standalone",
    "relUrl": "/source/basic/create_iar_or_keil_project_using_mcc/readme.html#launching-mcc-standalone"
  },"62": {
    "doc": "Create IAR or Keil project using MCC",
    "title": "Setting user preferences",
    "content": "User preferences can be set by navigating to Tools -&gt; Options. MCC allows user to configure two preferences . | Diff - Allows user to configure a diff tool. This is an important configuration, and is explained further down in project generation section. We can configure any third party diff tool. To set diff tool, navigate to its installation directory using the browse button and select the executable. {0} and {1} are place holders for the files that need to diffed during project file generation. In this example, we are using WinMerge as the diff tool. | Log - Allows user to set the log level. MCC displays the logs in the console window (seen at the bottom of the main window). It also saves them in the mcc.log file under .mh3 folder in user’s home directory. This log level decides the kind of messages that will get logged. | . ",
    "url": "http://localhost:4000/quick_docs/source/basic/create_iar_or_keil_project_using_mcc/readme.html#setting-user-preferences",
    "relUrl": "/source/basic/create_iar_or_keil_project_using_mcc/readme.html#setting-user-preferences"
  },"63": {
    "doc": "Create IAR or Keil project using MCC",
    "title": "Creating a new configuration",
    "content": "To create a new mcc configuration, choose File -&gt; New 32-bit MCC Harmony configuration. A new configuration creation dialog will popup, where we can enter the details of the configuration that we are about to create. | Framework Path - This is not configurable. Framework path defaults to the parent folder of the MCC repository. This folder is should contain relevant harmony 3 repositories required for project creation. Recommend using content manager for downloading and setting up Harmony 3 repositories. Make sure that the “Convert to relative path for configuration” check box is unchecked. | . Then, Click Next for Setup Configuration. | Project information - Under project information, user can choose the location of the project, name of the project and the name of the configuration. | Location - Location where the project and configuration will be created | Project name -Used by MCC when creating projects for target IDEs. If you want a KEIL or IAR project with specific name, it should be entered in this field | Configuration name - Used by MCC when creating configuration data | Family Filter - Allows us to choose the family filter of this configuration. In this example, select ATSAM in the family filter configuration. | Target Device - Device Family drop down limits the options to a specific family when choosing the target device, while Device Filter allows searching for a device by entering few characters. In this instance, ATSAMC21N18A MCU is chosen for creating the configuration. | . | Download the Required Mandatory Harmony Content if not downloaded. | The below MCC Content Manager window will open if the Mandatory Harmony Contents are not present in the Harmony Content Path mentioned in the above Step 4. | Click on the Finish Button in the MCC Content Manager Wizard to start downloading the Mandatory Harmony Content. | Note: For this demonstration application, the following MPLAB Harmony v3 packages are required: csp, harmony-services, CMSIS, and quick_docs. The MPLAB Harmony 3 Content Manager tool simplifies the downloading of the MPLAB Harmony v3 packages. If these packages are not downloaded, then the user can use the MPLAB Harmony 3 Content Manager tool to download them onto their computer. | If you need you can select the optional contents like bsp, core, CMSIS-FreeRTOS, etc and click apply, then Content Manager will start downloading these selected packages under the Harmony Content path. | Similarly, update the MCC Core Versions to the latest if not already updated. | . | . | . ",
    "url": "http://localhost:4000/quick_docs/source/basic/create_iar_or_keil_project_using_mcc/readme.html#creating-a-new-configuration",
    "relUrl": "/source/basic/create_iar_or_keil_project_using_mcc/readme.html#creating-a-new-configuration"
  },"64": {
    "doc": "Create IAR or Keil project using MCC",
    "title": "Making changes to the configuration",
    "content": "Refer to documentation on how to use the project graph for configuring Harmony 3 components using MCC. ",
    "url": "http://localhost:4000/quick_docs/source/basic/create_iar_or_keil_project_using_mcc/readme.html#making-changes-to-the-configuration",
    "relUrl": "/source/basic/create_iar_or_keil_project_using_mcc/readme.html#making-changes-to-the-configuration"
  },"65": {
    "doc": "Create IAR or Keil project using MCC",
    "title": "Generating code and project associated with a configuration",
    "content": ". | Select the target toolchain by clicking the system component in the project graph and choosing System -&gt; Project Configuration -&gt; Toolchain selections -&gt; Compilers in the configuration option window. Available options are XC32, IAR and KEIL. Some of these options might not be available for all targets. Choosing IAR or KEIL as the target compiler, will result in MCC creating IAR embedded workbench or Keil uVision IDE projects for the selected target. In this case, we have chosen KEIL as the toolchain. | Note: If the IAR Workbench or KEIL was not installed on the PC, MCC Standalone does not generate the project for the selected toolchain. | . | Click Generate button in Project Resources to start project generation. In the generation window, we can choose the merge strategies. | MCC identifies that there is a diff in the files it generated (for eg: modification within the project IDE), it will launch the configured diff tool. We can bring in the changes that are relevant and ignore the rest. Once the diff tool is closed, the project generation sequence is continued until the entire configuration is generated. | If IAR or KEIL is chosen as the toolchain, MCC will also create a folder containing the relevant project files which can then be opened using the corresponding IDE. The path of this folder, follows the rules explained in the “Setup Configuration” section. In this example, it would be under \\\"D:/Projects/My_Harmony_3/firmware/Hello_world/Hello_world.uvprojx\\\", since we choose keil as the the toolchain. | . ",
    "url": "http://localhost:4000/quick_docs/source/basic/create_iar_or_keil_project_using_mcc/readme.html#generating-code-and-project-associated-with-a-configuration",
    "relUrl": "/source/basic/create_iar_or_keil_project_using_mcc/readme.html#generating-code-and-project-associated-with-a-configuration"
  },"66": {
    "doc": "Create IAR or Keil project using MCC",
    "title": "Note",
    "content": "This page has been verified with the following versions of software tools: . | MPLAB X IDE v6.20 | MPLAB XC32 Compiler v4.40 | MPLAB Code Configurator Plugin v5.5.1 | MPLAB Harmony v3 “csp” repo v3.18.5 | . Because Microchip regularly update tools, occasionally there could be minor differences with the newer versions of the tools. ",
    "url": "http://localhost:4000/quick_docs/source/basic/create_iar_or_keil_project_using_mcc/readme.html#note",
    "relUrl": "/source/basic/create_iar_or_keil_project_using_mcc/readme.html#note"
  },"67": {
    "doc": "Create IAR or Keil project using MCC",
    "title": "Reference Links",
    "content": "                . ",
    "url": "http://localhost:4000/quick_docs/source/basic/create_iar_or_keil_project_using_mcc/readme.html#reference-links",
    "relUrl": "/source/basic/create_iar_or_keil_project_using_mcc/readme.html#reference-links"
  },"68": {
    "doc": "Create IAR or Keil project using MCC",
    "title": "Create IAR or Keil project using MCC",
    "content": "                                                                                                      . ",
    "url": "http://localhost:4000/quick_docs/source/basic/create_iar_or_keil_project_using_mcc/readme.html",
    "relUrl": "/source/basic/create_iar_or_keil_project_using_mcc/readme.html"
  },"69": {
    ...
    "doc": "Create a new MPLAB Harmony v3 project using MCC",
    "title": "Web Links",
    "content": ". | Create a new MPLAB Harmony v3 project using MCC | Creating the First Application on PIC32CM LSx Microcontrollers Using MPLAB Harmony v3 with MPLAB Code Configurator (MCC) | Dual Developer Application Development Use Case with TrustZone on SAM L11 Using MPLAB Harmony v3 | How to Set up the Tools Required to Get Started with MPLAB® Harmony v3 and MCC | MPLAB Harmony 3 Content Manager | . ",
    ...
    "content": "To create a new TrustZone project, in MPLAB® X IDE, Select File &gt; New Project or click . The New Project wizard will open. Perform following steps: . | Open the MPLAB® X IDE. | Create a New Project by clicking the New Project icon or by selecting File &gt; New Project. | In the New Project window select Application Project(s). | Click Next. Note: . | If the option 32-Bit MPLAB Harmony v3 Project is not available, install the MPLAB® Harmony 3 Launcher plug-in from Tools &gt; Plugins &gt; Available Plugins before continuing with this demonstration. | If the Harmony Content Path and Repository is not set, then go to Tools &gt; Options, select Pugins and select the Harmony Repository and enter the your Harmony Content Path as shown in the below figure to download the Harmony packages. | . | In the Select Device dialog window, select the target Device ATSAML11E16A from the drop-down menu as shown below and Click Next. | In the Select Compiler dialog window, select the latest or needed Compiler as follows: . | Click Next. | . | In the Select Project Name and Folder dialog window, fill in or select the information needed as follows: . | Project Name: Project naame i.e. “sam_l11_xpro” | Project Location: Select or Enter the Project Location of your choice. | For Example: sam_l11 and the Project Location is: . | C:/Users/&lt;user_id&gt;/MPLABXProjects/trustzone/sam_l11/firmware | . | Note: . | Kindly suffix the firmware folder name after the Project folder “sam_l11”. | . | . | Project Folder: This is a read-only field, MCC automatically creates a Secure and Non-Secure project folder as shown below. | Secure Project: C:/Users/&lt;user_id&gt;/MPLABXProjects/trustzone/sam_l11/firmware_secure . | Secure project .X folder can be fount at: . | C:/Users/&lt;user_id&gt;/MPLABXProjects/trustzone/sam_l11/firmware_secure/sam_l11_xpro.X | . | . | Non-Secure Project: C:/Users/&lt;user_id&gt;/MPLABXProjects/trustzone/sam_l11/firmware . | Non-Secure project .X folder can be fount at: . | C:/Users/&lt;user_id&gt;/MPLABXProjects/trustzone/sam_l11/firmware/sam_l11_xpro.X | . | . | Note: . | The project group is created in the Non-Secure project path i.e., | C:/Users/&lt;user_id&gt;/MPLABXProjects/trustzone/sam_l11/firmware/sam_l11_xprogroup | . | . | . | Click Finish. | Download the Required Mandatory Harmony Content if not downloaded. | The below MCC Content Manager window will open if the Mandatory Harmony Contents are not present in the Harmony Content Path mentioned in the Step 4. | Click on the Finish Button in the MCC Content Manager Wizard to start downloading the Mandatory Harmony Content. | Note: . | For this demonstration application, the following MPLAB Harmony v3 packages are required: csp, harmony-services, CMSIS, and quick_docs. The MPLAB Harmony 3 Content Manager tool simplifies the downloading of the MPLAB Harmony v3 packages. If these packages are not downloaded, then the user can use the MPLAB Harmony 3 Content Manager tool to download them onto their computer. | If you need you can select the optional contents like bsp, core, CMSIS-FreeRTOS, etc and click apply, then Content Manager will start downloading these selected packages under the Harmony Content path. | Similarly, update the MCC Core Versions to the latest if not already updated. | . | The MCC plug-in will open inside MPLAB® X window . | . | TrustZone Project uses two projects viz., Secure and Non-Secure Project that work together on the same MCU and offering security isolation between the Trusted and the Non-trusted resources in the device. | Secure Project: . | Secure project must be selected as Main Project to launch MCC. | Once the Harmony code is generated, Secure user application should be developed in secure “main.c”. | “nonsecure_entry.c” and “nonsecure_entry.h” files should be used for the Non-secure to Secure function calls. | Secure project is a loadable project from the Non-secure project. When Secure Project builds it generates Secure Gateway (SG) library ([configuration name]_Secure_sg_veneer.lib) which will be used by the Non-secure project while building the Non-secure project. | . | Non-secure Project: . | Once the Harmony code is generated, Non-secure user application should be developed in Non-secure “main.c”. | When Non-secure Project builds, it first builds Secure Project and then Non-secure project and generates target binaries to be executed on the device. | . | . | . ",
    ...
    "doc": "Create new TrustZone Project",
    "title": "Running TrustZone Project",
    ...
    "url": "http://localhost:4000/quick_docs/source/basic/create_new_trust_zone_project/readme.html#running-trustzone-project",
    "relUrl": "/source/basic/create_new_trust_zone_project/readme.html#running-trustzone-project"
  },"76": {
    "doc": "Create new TrustZone Project",
    "title": "Note",
    "content": "This page has been verified with the following versions of software tools: . | MPLAB X IDE v6.20 | MPLAB XC32 Compiler v4.40 | MPLAB Code Configurator Plugin v5.5.1 | MPLAB Harmony v3 “csp” repo v3.18.5 | . Because Microchip regularly update tools, occasionally there could be minor differences with the newer versions of the tools. ",
    ...
    "doc": "Create new TrustZone Project",
    "title": "References",
    "content": ". | SAML11 Xplained Pro Evaluation Kit User Guide and Datasheet | Creating the First Application on PIC32CM LSx Microcontrollers Using MPLAB Harmony v3 with MPLAB Code Configurator (MCC) | Dual Developer Application Development Use Case with TrustZone on SAM L11 Using MPLAB Harmony v3 | Arm® TrustZone® Getting Started Application on SAM L11 MCUs | How to Set up the Tools Required to Get Started with MPLAB® Harmony v3 and MCC | MPLAB Harmony 3 Content Manager | . ",
    "url": "http://localhost:4000/quick_docs/source/basic/create_new_trust_zone_project/readme.html#references",
    "relUrl": "/source/basic/create_new_trust_zone_project/readme.html#references"
  },"78": {
    "doc": "Create new TrustZone Project",
    "title": "Reference Links",
    "content": "                . ",
    ...
    "doc": "MCC Clock Configuration",
    "title": "MCC Clock Configuration",
    "content": "MCC plug-in consists of following plug-ins/managers based on the device selection while creating the project. | Clock Configuration: Enables to configure Master, Generic, Peripheral and System Clocks | Pin Configuration: Enables to configure pins in the Pin Configuration area depending upon the application requirements | NVIC Configuration: Enables to configure enable/disable of interrupts, interrupt priority and name | DMA Configuration: Enables to configure DMA Channels | MPU Configuration: Enables to configure different zones of Memory Protection Unit | . To open Clock Configuration MCC plug-in, perform the action, Project Graph → Plugins then click Clock Configuration . Note: MCC plugins availability will vary depending on the device selection while creating the project. ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_clock_configuration/readme.html#mcc-clock-configuration",
    "relUrl": "/source/basic/mcc_clock_configuration/readme.html#mcc-clock-configuration"
  },"101": {
    "doc": "MCC Clock Configuration",
    "title": "Clock Configuration",
    "content": "In the MCC, select the Clock Diagram Tab and verify that the clock is configured correctly for the selected target board. The Clock Diagram tab allows for easy setup of the master, system and peripheral clocks. See image below. Note: In the screenshot above, the MCC clock configuration for SAME70 MCU is shown as an example. The MCC clock configuration for other PIC or SAM MCUs may differ from the one shown above. ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_clock_configuration/readme.html#clock-configuration",
    "relUrl": "/source/basic/mcc_clock_configuration/readme.html#clock-configuration"
  },"102": {
    "doc": "MCC Clock Configuration",
    "title": "Note",
    "content": "This page has been verified with the following versions of software tools: . | MPLAB X IDE v6.20 | MPLAB XC32 Compiler v4.40 | MPLAB Code Configurator Plugin v5.5.1 | MPLAB Harmony v3 “csp” repo v3.18.5 | . Because Microchip regularly update tools, occasionally there could be minor differences with the newer versions of the tools. ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_clock_configuration/readme.html#note",
    "relUrl": "/source/basic/mcc_clock_configuration/readme.html#note"
  },"103": {
    "doc": "MCC Clock Configuration",
    "title": "Reference Links",
    "content": "                . ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_clock_configuration/readme.html#reference-links",
    "relUrl": "/source/basic/mcc_clock_configuration/readme.html#reference-links"
  },"104": {
    "doc": "MCC Clock Configuration",
    "title": "MCC Clock Configuration",
    "content": "                                                                                                      . ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_clock_configuration/readme.html",
    "relUrl": "/source/basic/mcc_clock_configuration/readme.html"
  },"105": {
    "doc": "MCC Code Generation",
    "title": "MCC Code Generation",
    "content": "The following covers the basic MCC operations and code generation process, which helps users to setup and configure MCC according to their needs. ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_code_generation/readme.html#mcc-code-generation",
    "relUrl": "/source/basic/mcc_code_generation/readme.html#mcc-code-generation"
  },"106": {
    "doc": "MCC Code Generation",
    "title": "Selecting and Configuring Modules",
    "content": "After opening the MCC, the peripheral and library modules can be added to the project by following these steps: . | In the Project Resources Area, select the peripheral or library module which needs to be configured by clicking on the module’s name. See 2. below image. | Configure the peripheral as required for the application in the Configuration Options Area. | Configure the pins in the Pin Manager depending on the application requirements. | . ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_code_generation/readme.html#selecting-and-configuring-modules",
    "relUrl": "/source/basic/mcc_code_generation/readme.html#selecting-and-configuring-modules"
  },"107": {
    "doc": "MCC Code Generation",
    "title": "Code Generation",
    "content": "To perform the following actions, press MCC Generate button in the Project Resources window. ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_code_generation/readme.html#code-generation",
    "relUrl": "/source/basic/mcc_code_generation/readme.html#code-generation"
  },"108": {
    "doc": "MCC Code Generation",
    "title": "Saving and Loading the MCC Configuration",
    "content": "Saving and loading the MCC configuration is integrated into the MPLAB® X IDE Load functions. The MCC configuration is saved whenever the Generate button is pressed.The MCC configuration file is included in the MPLAB® X IDE project, under the Important Files folder. The configuration file uses the extension .xml. Double-clicking on the MCC configuration file will cause that MCC configuration to be loaded. ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_code_generation/readme.html#saving-and-loading-the-mcc-configuration",
    "relUrl": "/source/basic/mcc_code_generation/readme.html#saving-and-loading-the-mcc-configuration"
  },"109": {
    "doc": "MCC Code Generation",
    "title": "Merge Window",
    "content": "If any of the files generated by the MCC has been edited outside of MCC and saved to the disk, then the Merge [MCC] window will appear in the Configuration Options. The Merge [MCC] window allows you to decide whether to keep the edits, or to replace them with the MCC newly generated code. When the newly generated MCC content has been accepted, MCC makes the changes to the file. To the MPLAB® X IDE, these changes are the same as if you typed in the new content. The normal MPLAB® X IDE edit undo can be used in the MCC Merge operation. A list of all the files that need to be merged appear one after another after resolving the merge conflicts. You must resolve merge conflicts to ensure that all the newly generated code is incorporated into the project. At the top of the Merge [MCC] window, in the center margin, there is an arrow, as shown in the following Merge Window Figure. Clicking on the arrow will replace all your edits in the current file with the MCC updated code that the MCC has just generated. The numbers above the arrow indicate the current difference and the total number of differences. The individual lines of MCC Updated Code can be selected to replace the edited code. As shown in the following Merge Window Figure, clicking on the arrows in the right margin of the left window will copy the MCC Updated Code to the generated driver file. Once the changes are accepted, the Merge mechanism will remove the highlighted file and highlight the next file on the list. To insure all updates are completed, a warning will be generated if the Merge mechanism is closed before all the changes are accepted. Note: Your edits will never be overwritten by the MCC generated code, except by explicit action in the Merge [MCC] window. When changes have been made both to a generated file and in the corresponding MCC UI within the Configuration Options, the Merge [MCC] window shown in the following Merge Window Figure will be displayed. The Merge [MCC] window allows you to resolve the conflicts between the newly generated file and the edits you have made to the file. ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_code_generation/readme.html#merge-window",
    "relUrl": "/source/basic/mcc_code_generation/readme.html#merge-window"
  },"110": {
    "doc": "MCC Code Generation",
    "title": " ",
    "content": " ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_code_generation/readme.html",
    "relUrl": "/source/basic/mcc_code_generation/readme.html"
  },"111": {
    "doc": "MCC Code Generation",
    "title": "Merge Window Figure",
    "content": ". ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_code_generation/readme.html#merge-window-figure",
    "relUrl": "/source/basic/mcc_code_generation/readme.html#merge-window-figure"
  },"112": {
    "doc": "MCC Code Generation",
    ...
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_code_generation/readme.html#generated-source-and-header-files",
    "relUrl": "/source/basic/mcc_code_generation/readme.html#generated-source-and-header-files"
  },"113": {
    "doc": "MCC Code Generation",
    "title": "Note",
    "content": "This page has been verified with the following versions of software tools: . | MPLAB X IDE v6.20 | MPLAB XC32 Compiler v4.40 | MPLAB Code Configurator Plugin v5.5.1 | MPLAB Harmony v3 “csp” repo v3.18.5 | . Because Microchip regularly update tools, occasionally there could be minor differences with the newer versions of the tools. ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_code_generation/readme.html#note",
    "relUrl": "/source/basic/mcc_code_generation/readme.html#note"
  },"114": {
    "doc": "MCC Code Generation",
    "title": "Reference Links",
    "content": "                . ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_code_generation/readme.html#reference-links",
    "relUrl": "/source/basic/mcc_code_generation/readme.html#reference-links"
  },"115": {
    "doc": "MCC Code Generation",
    "title": "MCC Code Generation",
    "content": "                                                                                                      . ",
    ...
    "title": "MCC DMA Configuration",
    "content": "MCC plug-in consists of following plug-ins/managers based on the device selection while creating the project. | Clock Configuration: Enables to configure Master, Generic, Peripheral and System Clocks | Pin Configuration: Enables to configure pins in the Pin Configuration area depending upon the application requirements | NVIC Configuration: Enables to configure enable/disable of interrupts, interrupt priority and name | DMA Configuration: Enables to configure DMA Channels | MPU Configuration: Enables to configure different zones of Memory Protection Unit | . To open DMA Configuration MCC plug-in, perform the action, MCC → Tools then click DMA Configuration . Note: MCC plugins availability will vary depending on the device selection while creating the project. ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_dma_configuration/readme.html#mcc-dma-configuration",
    "relUrl": "/source/basic/mcc_dma_configuration/readme.html#mcc-dma-configuration"
  },"117": {
    "doc": "MHC DMA Configuration",
    "title": "DMA Configuration",
    "content": "Users can add a channel and perform the channel settings, such as setting up source and destination address mode, interface identifier, data width, chunk size, and memory burst size. See image below. Note: In the screenshot above, the MCC DMA configuration for SAME70 MCU is shown as an example. The MCC DMA configuration for other PIC or SAM MCUs may differ from the one shown above. ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_dma_configuration/readme.html#dma-configuration",
    "relUrl": "/source/basic/mcc_dma_configuration/readme.html#dma-configuration"
  },"118": {
    "doc": "MHC DMA Configuration",
    "title": "Note",
    "content": "This page has been verified with the following versions of software tools: . | MPLAB X IDE v6.20 | MPLAB XC32 Compiler v4.40 | MPLAB Code Configurator Plugin v5.5.1 | MPLAB Harmony v3 “csp” repo v3.18.5 | . Because Microchip regularly update tools, occasionally there could be minor differences with the newer versions of the tools. ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_dma_configuration/readme.html#note",
    "relUrl": "/source/basic/mcc_dma_configuration/readme.html#note"
  },"119": {
    "doc": "MHC DMA Configuration",
    "title": "Reference Links",
    "content": "                . ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_dma_configuration/readme.html#reference-links",
    "relUrl": "/source/basic/mcc_dma_configuration/readme.html#reference-links"
  },"120": {
    "doc": "MHC DMA Configuration",
    "title": "MHC DMA Configuration",
    "content": "                                                                                                      . ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_dma_configuration/readme.html",
    "relUrl": "/source/basic/mcc_dma_configuration/readme.html"
  },"121": {
    "doc": "MCC Memory Protection Unit Configuration",
    "title": "MCC Memory protection Unit (MPU) Configuration",
    "content": "MCC plug-in consists of following plug-ins/managers based on the device selection while creating the project. | Clock Configuration: Enables to configure Master, Generic, Peripheral and System Clocks | Pin Configuration: Enables to configure pins in the Pin Configuration area depending upon the application requirements | NVIC Configuration: Enables to configure enable/disable of interrupts, interrupt priority and name | DMA Configuration: Enables to configure DMA Channels | MPU Configuration: Enables to configure different zones of Memory Protection Unit | . To open MPU Configuration MCC plug-in, perform the action, MCC → Tools then click MPU Configuration . Note: MCC plugins availability will vary depending on the device selection while creating the project. ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_memory_protection_unit_configuration/readme.html#mcc-memory-protection-unit-mpu-configuration",
    "relUrl": "/source/basic/mcc_memory_protection_unit_configuration/readme.html#mcc-memory-protection-unit-mpu-configuration"
  },"122": {
    "doc": "MCC Memory Protection Unit Configuration",
    "title": "MPU Configuration",
    "content": "Users can configure MPU regions for memory spaces, such as ITCM, DTCM, Flash, SRAM, Peripherals, EBI, QSPI, USBHS and System. Users can also set the different attributes for these memory spaces. See image below: . Note: In the screenshot above, the MCC MPU configuration for SAME70 MCU is shown as an example. The MCC MPU configuration for other PIC or SAM MCUs may differ from the one shown above. ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_memory_protection_unit_configuration/readme.html#mpu-configuration",
    "relUrl": "/source/basic/mcc_memory_protection_unit_configuration/readme.html#mpu-configuration"
  },"123": {
    "doc": "MCC Memory Protection Unit Configuration",
    "title": "Note",
    "content": "This page has been verified with the following versions of software tools: . | MPLAB X IDE v6.20 | MPLAB XC32 Compiler v4.40 | MPLAB Code Configurator Plugin v5.5.1 | MPLAB Harmony v3 “csp” repo v3.18.5 | . Because Microchip regularly update tools, occasionally there could be minor differences with the newer versions of the tools. ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_memory_protection_unit_configuration/readme.html#note",
    "relUrl": "/source/basic/mcc_memory_protection_unit_configuration/readme.html#note"
  },"124": {
    "doc": "MCC Memory Protection Unit Configuration",
    "title": "Reference Links",
    "content": "                . ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_memory_protection_unit_configuration/readme.html#reference-links",
    "relUrl": "/source/basic/mcc_memory_protection_unit_configuration/readme.html#reference-links"
  },"125": {
    "doc": "MCC Memory Protection Unit Configuration",
    "title": "MCC Memory Protection Unit Configuration",
    "content": "                                                                                                      . ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_memory_protection_unit_configuration/readme.html",
    "relUrl": "/source/basic/mcc_memory_protection_unit_configuration/readme.html"
  },"126": {
    "doc": "MCC NVIC Configuration",
    "title": "MCC NVIC Configuration",
    "content": "MCC plug-in consists of following plug-ins/managers based on the device selection while creating the project. | Clock Configuration: Enables to configure Master, Generic, Peripheral and System Clocks | Pin Configuration: Enables to configure pins in the Pin Configuration area depending upon the application requirements | NVIC Configuration: Enables to configure enable/disable of interrupts, interrupt priority and name | DMA Configuration: Enables to configure DMA Channels | MPU Configuration: Enables to configure different zones of Memory Protection Unit | . To open NVIC Configuration MCC plug-in, perform the action, Project Graph → Plugins then click NVIC Configuration . Note: MCC plugins availability will vary depending on the device selection while creating the project. ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_nvic_configuration/readme.html#mcc-nvic-configuration",
    "relUrl": "/source/basic/mcc_nvic_configuration/readme.html#mcc-nvic-configuration"
  },"127": {
    "doc": "MCC NVIC Configuration",
    "title": "NVIC Configuration",
    "content": "NVIC Manager allows users to enable or disable interrupts, change priority, and change names of interrupt handlers, see image below. | . Note: In the screenshot above, the MCC NVIC configuration for SAME70 MCU is shown as an example. The MCC NVIC configuration for other PIC or SAM MCUs may differ from the one shown above. ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_nvic_configuration/readme.html#nvic-configuration",
    "relUrl": "/source/basic/mcc_nvic_configuration/readme.html#nvic-configuration"
  },"128": {
    "doc": "MCC NVIC Configuration",
    "title": "Note",
    "content": "This page has been verified with the following versions of software tools: . | MPLAB X IDE v6.20 | MPLAB XC32 Compiler v4.40 | MPLAB Code Configurator Plugin v5.5.1 | MPLAB Harmony v3 “csp” repo v3.18.5 | . Because Microchip regularly update tools, occasionally there could be minor differences with the newer versions of the tools. ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_nvic_configuration/readme.html#note",
    "relUrl": "/source/basic/mcc_nvic_configuration/readme.html#note"
  },"129": {
    "doc": "MCC NVIC Configuration",
    "title": "Reference Links",
    "content": "                . ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_nvic_configuration/readme.html#reference-links",
    "relUrl": "/source/basic/mcc_nvic_configuration/readme.html#reference-links"
  },"130": {
    "doc": "MCC NVIC Configuration",
    "title": "MCC NVIC Configuration",
    "content": "                                                                                                      . ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_nvic_configuration/readme.html",
    "relUrl": "/source/basic/mcc_nvic_configuration/readme.html"
  },"131": {
    "doc": "MPLAB Code Configurator Overview with MPLAB Harmony Content",
    "title": "MPLAB Code Configurator Overview with MPLAB Harmony Content",
    "content": "This guide will show you how to install the MPLAB® Code Configurator (MCC) plugin and how to download MPLAB Harmony framework. It also provides a brief overview of the MCC user interface. MPLAB Code Configurator enables, configures and utilizes a rich set of peripherals across a select list of devices. It’s integrated into MPLAB X Integrated Development Environment (IDE) to provide a very powerful and extremely easy-to-use development platform. The MPLAB Code Configurator plugin includes the MCC Content Manager Wizard. The MCC Content Manager Wizard is used to download and update the Harmony 3 framework on your local machine. You should install MPLAB Code Configurator before downloading the framework. For more information refer the links below. ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_overview_with_harmony_3/readme.html#mplab-code-configurator-overview-with-mplab-harmony-content",
    "relUrl": "/source/basic/mcc_overview_with_harmony_3/readme.html#mplab-code-configurator-overview-with-mplab-harmony-content"
  },"132": {
    "doc": "MPLAB Code Configurator Overview with MPLAB Harmony Content",
    "title": " ",
    "content": " ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_overview_with_harmony_3/readme.html",
    "relUrl": "/source/basic/mcc_overview_with_harmony_3/readme.html"
  },"133": {
    "doc": "MPLAB Code Configurator Overview with MPLAB Harmony Content",
    "title": "Web Links",
    "content": ". | MPLAB Code Configurator Overview with MPLAB Harmony Content | How to Set up the Tools Required to Get Started with MPLAB® Harmony v3 and MCC | MPLAB Harmony 3 Content Manager | . ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_overview_with_harmony_3/readme.html#web-links",
    "relUrl": "/source/basic/mcc_overview_with_harmony_3/readme.html#web-links"
  },"134": {
    "doc": "MPLAB Code Configurator Overview with MPLAB Harmony Content",
    "title": "Reference Links",
    "content": "                . ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_overview_with_harmony_3/readme.html#reference-links",
    "relUrl": "/source/basic/mcc_overview_with_harmony_3/readme.html#reference-links"
  },"135": {
    "doc": "MPLAB Code Configurator Overview with MPLAB Harmony Content",
    "title": "MPLAB Code Configurator Overview with MPLAB Harmony Content",
    "content": "                                                                                                      . ",
    ...
    "doc": "MCC Pin Configuration",
    "title": "MCC Pin Configuration",
    "content": "MCC plug-in consists of following plug-ins/managers based on the device selection while creating the project. | Clock Configuration: Enables to configure Master, Generic, Peripheral and System Clocks | Pin Configuration: Enables to configure pins in the Pin Configuration area depending upon the application requirements | NVIC Configuration: Enables to configure enable/disable of interrupts, interrupt priority and name | DMA Configuration: Enables to configure DMA Channels | MPU Configuration: Enables to configure different zones of Memory Protection Unit | . To open Pin Configuration MCC plug-in, perform the action, Project Graph → Plugins then click Pin Configuration . | . Note: MCC plugins availability will vary depending on the device selection while creating the project. ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_pin_configuration/readme.html#mcc-pin-configuration",
    "relUrl": "/source/basic/mcc_pin_configuration/readme.html#mcc-pin-configuration"
  },"137": {
    "doc": "MCC Pin Configuration",
    "title": "Pin Configuration",
    "content": "The Pin Manager consists of Pin Settings, the Pin Diagram, and the Pin Table tabs, which enables users to configure (assign peripheral function, set pin direction, configure pull-up or pull-down and so on) and map the I/O pins. The following color combinations are associated with the pins in the graphical or table View: . | Gray: This pin is not usable in the selected configuration, and there is no enabled module which has any functionality on that pin. The grayed-out locks on a white background indicates the pins that are locked out by selected system functions. | Blue: This pin is available and can be allocated to a module. | Green (with a lock): This pin is allocated and selected for a module. The name displayed against the pin is either the name of the pin in the module’s context or a custom name entered. | . Pin Diagram . It is the pictorial representation of the available, assigned and not available pins of the Microcontroller. See image below. | . Pin Table . The pin table provides the Pin Manager Grid View. Using Pin Table users can perform these actions: . | The device package can be selected from the drop-down list. | The package can be selected from the upper left side of the Pin Manager Table View. The Package drop-down list shows the LQFP144 package is selected and the selected package details are displayed in the Package View. The pin numbers in the Table View provides the pin numbers for the selected package. The three leftmost columns in the Table View indicate the module’s name, functionality name, and the direction. | | . Pin Settings . Pin settings enables the user to configure the pins. Users can provide custom name for pin, change the pin function, direction, latch and other properties, see image below. | . Note: In the screenshots above, the MCC pin configuration for SAME70 MCU is shown as an example. The MCC pin configuration for other PIC or SAM MCUs may differ from the one shown above. ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_pin_configuration/readme.html#pin-configuration",
    "relUrl": "/source/basic/mcc_pin_configuration/readme.html#pin-configuration"
  },"138": {
    "doc": "MCC Pin Configuration",
    "title": "Note",
    "content": "This page has been verified with the following versions of software tools: . | MPLAB X IDE v6.20 | MPLAB XC32 Compiler v4.40 | MPLAB Code Configurator Plugin v5.5.1 | MPLAB Harmony v3 “csp” repo v3.18.5 | . Because Microchip regularly update tools, occasionally there could be minor differences with the newer versions of the tools. ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_pin_configuration/readme.html#note",
    "relUrl": "/source/basic/mcc_pin_configuration/readme.html#note"
  },"139": {
    "doc": "MCC Pin Configuration",
    "title": "Reference Links",
    "content": "                . ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_pin_configuration/readme.html#reference-links",
    "relUrl": "/source/basic/mcc_pin_configuration/readme.html#reference-links"
  },"140": {
    "doc": "MCC Pin Configuration",
    "title": "MCC Pin Configuration",
    "content": "                                                                                                      . ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_pin_configuration/readme.html",
    "relUrl": "/source/basic/mcc_pin_configuration/readme.html"
  },"141": {
    "doc": "MPLAB Code Configurator Options",
    "title": "MPLAB Code Configurator Options",
    "content": "Several aspects of the operation of the MPLAB® Code Configurator (MCC) can be managed by using the Options panel which can be invoked by clicking Tools&gt;Options&gt;Plugins. ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_plugin_configurations/readme.html#mplab-code-configurator-options",
    "relUrl": "/source/basic/mcc_plugin_configurations/readme.html#mplab-code-configurator-options"
  },"142": {
    "doc": "MPLAB Code Configurator Options",
    "title": "File Handling",
    "content": "There are two options for file handling: . Remove unused files from the project: Enabling this option tells the MCC to remove .c and .h files for modules which were removed from the MCC configuration between the subsequent generation procedures. This option ensures that the files which are included in the project (and thus in the compilation) are only those which are strictly necessary. However, this will not delete the files from the disk. Delete unused files from the disk: This option gets enabled only when selecting ‘Remove unused files from the project’. This performs the additional task of deleting unused files from the disk and therefore, files cannot be recovered anymore. ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_plugin_configurations/readme.html#file-handling",
    "relUrl": "/source/basic/mcc_plugin_configurations/readme.html#file-handling"
  },"143": {
    "doc": "MPLAB Code Configurator Options",
    "title": "MCC Line Endings",
    "content": "Specify the type of line endings to use in the files generated by MCC. The default is DOS (CRLF). Unix line endings (LF) may be specified. ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_plugin_configurations/readme.html#mcc-line-endings",
    "relUrl": "/source/basic/mcc_plugin_configurations/readme.html#mcc-line-endings"
  },"144": {
    "doc": "MPLAB Code Configurator Options",
    "title": "Editor Behaviour",
    "content": "There are three options for the IDE operations. Always ask before removing a module: Enabling this control enables the Are you sure? dialog box which appears while disabling or removing an enabled module. Always ask before removing a pin: Enabling this control enables the Are you sure? dialog box which appears while deallocating or removing a pin from a peripheral. Autosave MCC Configuration file: By default, the Autosave MPLAB® Code Configuration (MCC) configuration file option is enabled. That means MCC automatically saves your MCC configurations. ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_plugin_configurations/readme.html#editor-behaviour",
    "relUrl": "/source/basic/mcc_plugin_configurations/readme.html#editor-behaviour"
  },"145": {
    "doc": "MPLAB Code Configurator Options",
    "title": "MCC Libraries",
    "content": "Libraries can be added or removed through this setup. | Use the Install Library/Core button to add an MCC modular Library or Core to the MCC plugin. | Use the Open Library Core Folder button to view the MCC modular Libraries/Core folder. | Use the Remove Library/Core button to remove an MCC Library or Core to the MCC plugin. | . ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_plugin_configurations/readme.html#mcc-libraries",
    "relUrl": "/source/basic/mcc_plugin_configurations/readme.html#mcc-libraries"
  },"146": {
    "doc": "MPLAB Code Configurator Options",
    "title": "Note",
    "content": "This page has been verified with the following versions of software tools: . | MPLAB X IDE v6.20 | MPLAB XC32 Compiler v4.40 | MPLAB Code Configurator Plugin v5.5.1 | MPLAB Harmony v3 “csp” repo v3.18.5 | . Because Microchip regularly update tools, occasionally there could be minor differences with the newer versions of the tools. ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_plugin_configurations/readme.html#note",
    "relUrl": "/source/basic/mcc_plugin_configurations/readme.html#note"
  },"147": {
    "doc": "MPLAB Code Configurator Options",
    "title": "Reference Links",
    "content": "                . ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_plugin_configurations/readme.html#reference-links",
    "relUrl": "/source/basic/mcc_plugin_configurations/readme.html#reference-links"
  },"148": {
    "doc": "MPLAB Code Configurator Options",
    "title": "MPLAB Code Configurator Options",
    "content": "                                                                                                      . ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_plugin_configurations/readme.html",
    "relUrl": "/source/basic/mcc_plugin_configurations/readme.html"
  },"149": {
    "doc": "MCC Project Graph",
    ...
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_project_graph/readme.html#mcc-project-graph",
    "relUrl": "/source/basic/mcc_project_graph/readme.html#mcc-project-graph"
  },"150": {
    "doc": "MCC Project Graph",
    ...
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_project_graph/readme.html#generic-capability-and-dependency",
    "relUrl": "/source/basic/mcc_project_graph/readme.html#generic-capability-and-dependency"
  },"151": {
    "doc": "MCC Project Graph",
    ...
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_project_graph/readme.html#multi-dependency-and-multi-capability",
    "relUrl": "/source/basic/mcc_project_graph/readme.html#multi-dependency-and-multi-capability"
  },"152": {
    "doc": "MCC Project Graph",
    ...
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_project_graph/readme.html#container-or-group-creation",
    "relUrl": "/source/basic/mcc_project_graph/readme.html#container-or-group-creation"
  },"153": {
    "doc": "MCC Project Graph",
    "title": "Note",
    "content": "This page has been verified with the following versions of software tools: . | MPLAB X IDE v6.20 | MPLAB XC32 Compiler v4.40 | MPLAB Code Configurator Plugin v5.5.1 | MPLAB Harmony v3 “csp” repo v3.18.5 | . Because Microchip regularly update tools, occasionally there could be minor differences with the newer versions of the tools. ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_project_graph/readme.html#note",
    "relUrl": "/source/basic/mcc_project_graph/readme.html#note"
  },"154": {
    "doc": "MCC Project Graph",
    "title": "Reference Links",
    "content": "                . ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_project_graph/readme.html#reference-links",
    "relUrl": "/source/basic/mcc_project_graph/readme.html#reference-links"
  },"155": {
    "doc": "MCC Project Graph",
    "title": "MCC Project Graph",
    "content": "                                                                                                      . &lt;/span&gt; . ",
    "url": "http://localhost:4000/quick_docs/source/basic/mcc_project_graph/readme.html",
    "relUrl": "/source/basic/mcc_project_graph/readme.html"
  },"156": {
    "doc": "MPLAB Code Configurator (MCC) for Harmony 3 Projects",
    "title": "MPLAB Code Configurator (MCC) for Harmony 3 Projects",
    "content": "MPLAB Harmony v3 is now configurable through MPLAB Code Configurator (MCC). Refer to the below links for specific instructions to use MPLAB Harmony v3 with MCC. | Create a new MPLAB Harmony v3 project using MCC | Update and Configure an Existing MHC-based MPLAB Harmony v3 Project to MCC-based Project | How to Set up the Tools Required to Get Started with MPLAB® Harmony v3 and MCC | . ",
    ...
    "content": "Erase the contents of the NAND Flash memory on the SAM9X60-board with the following command: . sam-ba -p serial -b sam9x60-ek -a nandflash -c erase sam-ba -p serial -b sam9x60-curiosity -a nandflash -c erase . Example: . ",
    ...
    "content": "Program the boot.bin file on the SAM9X60-board with the following command: . sam-ba -p serial -b sam9x60-ek -a nandflash -c writeboot:boot.bin sam-ba -p serial -b sam9x60-curiosity -a nandflash -c writeboot:boot.bin . | Note: Change directory to the location of boot.bin Example: | . Note: Refer this link to configure and build the at91bootstrap to load the application from NAND flash memory. The at91bootstrap file (boot.bin) built with NAND configuration only to be used here. ",
    ...
    "content": "To program the application binary, harmony.bin file on the SAM9X60_board, use the following command: . sam-ba -p serial -b sam9x60-ek -a nandflash -c write:harmony.bin:NAND_OFFSET sam-ba -p serial -b sam9x60-curiosity -a nandflash -c write:harmony.bin:NAND_OFFSET . Note: * The NAND_OFFSET should be same as the one used in the KCONFIG, while configuring the at91bootstrap to load from external NAND flash. * Change directory to the location of harmony.bin. Example: . ",
    ...
    "content": ". | MPLAB® X IDE | MPLAB® XC32 Compiler | MPLAB® Code Configurator (MCC) | . This project has been verified to work with the following versions of software tools: . | mcc_version: v5.4.1 | mcc_core_version: v5.6.1 | mplabx_version: v6.15 | harmony_version: v1.2.0 | compiler: XC32 (v4.40) | . ",
    ...
    "content": "This page contains quick documentation for MPLAB® Harmony 3 Basics. | MPLAB® Code Configurator Overview with MPLAB Harmony Content . | MPLAB Code Configurator (MCC) for Harmony 3 Projects . | Create a new MPLAB Harmony v3 project using MCC . | Update and Configure an Existing MHC-based MPLAB Harmony v3 Project to MCC-based Project . | MCC Project Graph . | MCC Clock Configuration . | MCC Pin Configuration . | MCC NVIC Configuration . | MCC DMA Configuration . | MCC Memory protection Unit Configuration . | MCC Code Generation . | MCC Plugin Configuration . | Create First MPLAB Harmony 3 Project . | Create “Hello World” application on SAM MCUs . | Create “Hello World” application on PIC MCUs . | Create First MPLAB Harmony 3 PIC32CZ CAx Project . | Create First MPLAB Harmony 3 PIC32CM JH01 Project . | Create First MPLAB Harmony 3 PIC32CM LSx Project . | Create First MPLAB Harmony 3 PIC32CX SG Project . | Create IAR or Keil project using MCC . | Create new TrustZone Project . | Differences Between MPLAB Harmony v3 Synchronous and Asynchronous Drivers . | Difference Between MPLAB Harmony v3 PLIBs and Drivers . | MPLAB Harmony v3 Synchronous drivers and their usage in FreeRTOS based applications . | Add a New Configuration to an Existing MPLAB Harmony v3 Project . | MPLAB Harmony v3 Project Manifest Feature . | . ",
    ...
    "doc": "Harmony Basics",
    "title": "Web Links",
    "content": ". | 32-bit Microcontroller Collateral and Solutions Reference Guide | How to Get Started with MPLAB Harmony v3 | How to Set up the Tools Required to Get Started with MPLAB® Harmony v3 and MCC | MPLAB Harmony 3 Content Manager | Create a New MPLAB Harmony v3 Project | Creating the First Application on PIC32CM JH01 Microcontrollers Using MPLAB Harmony v3 with MPLAB Code Configurator (MCC) | Creating the First Application on PIC32CZ CAx Microcontrollers Using MPLAB Harmony v3 with MPLAB Code Configurator (MCC) | Creating the First Application on PIC32CX SG Microcontrollers Using MPLAB Harmony v3 with MPLAB Code Configurator (MCC) | Creating the First Application on PIC32CM LSx Microcontrollers Using MPLAB Harmony v3 with MPLAB Code Configurator (MCC) | Creating the First Application on PIC32CM LSx Microcontrollers Using MPLAB Harmony v3 with MPLAB Code Configurator (MCC) | Dual Developer Application Development Use Case with TrustZone on SAM L11 Using MPLAB Harmony v3 | How to Use the MPLAB® Data Visualizer with 32-bit MCU-based Curiosity Nano Evaluation Kits | . ",
    ...
    "doc": "File Transfer Protocol Using MPLAB Harmony v3 TCP/IP Stack for SAM E54 MCU",
    "title": "File Transfer Protocol Using MPLAB Harmony v3 TCP/IP Stack for SAM E54 MCU",
    "content": "The File Transfer Protocol (FTP) is a standard internet protocol provided by TCP/IP for transmitting files from one device to another. It is an application layer protocol within the TCP/IP stack layers. An embedded FTP client/server is an excellent addition to any network-enabled device. The FTP client module will enable your application to upload and download files from any FTP server. This protocol enables data transfer reliably and efficiently between different devices without worrying about the file storage systems of a Host. This document focuses on the FTP implementation of the MPLAB Harmony v3 TCP/IP stack. It also provides a combined FTP client and FTP server demonstration using the SAM E54 microcontroller. The FTP client application has an Ethernet bootloader that downloads the application binary from the FTP server and updates the firmware by self-programming. For more information refer the links below. ",
    "url": "http://localhost:4000/quick_docs/source/middleware/ftp_harmony_tcpip/readme.html#file-transfer-protocol-using-mplab-harmony-v3-tcpip-stack-for-sam-e54-mcu",
    "relUrl": "/source/middleware/ftp_harmony_tcpip/readme.html#file-transfer-protocol-using-mplab-harmony-v3-tcpip-stack-for-sam-e54-mcu"
  },"316": {
    "doc": "File Transfer Protocol Using MPLAB Harmony v3 TCP/IP Stack for SAM E54 MCU",
    "title": " ",
    "content": " ",
    "url": "http://localhost:4000/quick_docs/source/middleware/ftp_harmony_tcpip/readme.html",
    "relUrl": "/source/middleware/ftp_harmony_tcpip/readme.html"
  },"317": {
    "doc": "File Transfer Protocol Using MPLAB Harmony v3 TCP/IP Stack for SAM E54 MCU",
    "title": "Web Links",
    "content": ". | File Transfer Protocol Using MPLAB Harmony v3 TCP/IP Stack for SAM E54 MCU | . ",
    "url": "http://localhost:4000/quick_docs/source/middleware/ftp_harmony_tcpip/readme.html#web-links",
    "relUrl": "/source/middleware/ftp_harmony_tcpip/readme.html#web-links"
  },"318": {
    "doc": "File Transfer Protocol Using MPLAB Harmony v3 TCP/IP Stack for SAM E54 MCU",
    "title": "Reference Links",
    "content": "                . ",
    "url": "http://localhost:4000/quick_docs/source/middleware/ftp_harmony_tcpip/readme.html#reference-links",
    "relUrl": "/source/middleware/ftp_harmony_tcpip/readme.html#reference-links"
  },"319": {
    "doc": "File Transfer Protocol Using MPLAB Harmony v3 TCP/IP Stack for SAM E54 MCU",
    "title": "File Transfer Protocol Using MPLAB Harmony v3 TCP/IP Stack for SAM E54 MCU",
    "content": "                                                                                                      . ",
    ...
    "doc": "Secure Boot on PIC32CM LS60 Curiosity Pro Evaluation Kit using MPLAB® Harmony v3",
    "title": "Secure Boot on PIC32CM LS60 Curiosity Pro Evaluation Kit using MPLAB Harmony v3",
    "content": "This tutorial shows how to use the Secure Boot feature on the PIC32CM LS60 microcontroller (MCU) using ATECC608B to create a Secure Bootloader and an application that is loaded using the Secure Bootloader. This tutorial helps you get started in developing secure applications on PIC32CM LS60 MCUs using Microchip’s Trust Platform Design Suite (TPDS) and MPLAB Harmony v3 software framework. The project you create will run on the PIC32CM LS60 Curiosity Pro Evaluation Kit (EV76R77A). The application demonstrates the development of two projects. | A Secure Bootloader | A Test Application | . Secure Bootloader: The Secure Bootloader on PIC32CM LS60 provides a layer of security to the boot process by checking the integrity of the Bootloader before moving to program a firmware image into the device’s Flash memory. This helps prevent unauthorized access and malicious code from being loaded onto the device. The Secure Bootloader implements a security layer through the Secure Boot feature on PIC32CM LS60 devices. The process typically involves: . | Storing cryptographic keys: Public and private key pairs are generated, with the private key securely stored in the secure element and the public key programmed into the MCU. | Signing: The bootloader code is signed using the private key, creating a digital signature that is appended to the bootloader code image. | Verification: When the MCU boots, the Bootloader’s digital signature is checked using the public key stored in the device. If the signature is valid, it confirms the Bootloader’s integrity and authenticity, allowing it to execute and load the application firmware (if needed). | . Test Application: The test application firmware is sent by a host PC (running a script) interfaced to the PIC32CM LS60 MCU through UART. The test application image is received and loaded by the Secure Bootloader. The test application you create will utilize the following peripherals: . | SERCOM2 (as Universal Synchronous Asynchronous Receiver Transmitter (USART)) peripheral library to communicate with the PC utility for receiving the test application image using the Bootloader library. | NVMCTRL peripheral library to read or write the firmware image from the Flash memory. | . For more information refer the links below. ",
    "url": "http://localhost:4000/quick_docs/source/middleware/pic32cmls60_secure_boot/readme.html#secure-boot-on-pic32cm-ls60-curiosity-pro-evaluation-kit-using-mplab-harmony-v3",
    "relUrl": "/source/middleware/pic32cmls60_secure_boot/readme.html#secure-boot-on-pic32cm-ls60-curiosity-pro-evaluation-kit-using-mplab-harmony-v3"
  },"361": {
    "doc": "Secure Boot on PIC32CM LS60 Curiosity Pro Evaluation Kit using MPLAB® Harmony v3",
    "title": " ",
    "content": " ",
    "url": "http://localhost:4000/quick_docs/source/middleware/pic32cmls60_secure_boot/readme.html",
    "relUrl": "/source/middleware/pic32cmls60_secure_boot/readme.html"
  },"362": {
    "doc": "Secure Boot on PIC32CM LS60 Curiosity Pro Evaluation Kit using MPLAB® Harmony v3",
    "title": "Web Links",
    "content": ". | Secure Boot on PIC32CM LS60 Curiosity Pro Evaluation Kit using MPLAB® Harmony v3 | . ",
    "url": "http://localhost:4000/quick_docs/source/middleware/pic32cmls60_secure_boot/readme.html#web-links",
    "relUrl": "/source/middleware/pic32cmls60_secure_boot/readme.html#web-links"
  },"363": {
    "doc": "Secure Boot on PIC32CM LS60 Curiosity Pro Evaluation Kit using MPLAB® Harmony v3",
    "title": "Reference Links",
    "content": "                . ",
    "url": "http://localhost:4000/quick_docs/source/middleware/pic32cmls60_secure_boot/readme.html#reference-links",
    "relUrl": "/source/middleware/pic32cmls60_secure_boot/readme.html#reference-links"
  },"364": {
    "doc": "Secure Boot on PIC32CM LS60 Curiosity Pro Evaluation Kit using MPLAB® Harmony v3",
    "title": "Secure Boot on PIC32CM LS60 Curiosity Pro Evaluation Kit using MPLAB® Harmony v3",
    "content": "                                                                                                      . ",
    ...
    "doc": "Getting Started with Middleware on PIC32MZ EF MCUs",
    "title": "Web Links",
    "content": ". | Getting Started with MPLAB® Harmony v3 Drivers and Middleware on PIC32MZ EF MCUs using FreeRTOS | . ",
    ...
    "doc": "Audio Tone using a lookup table",
    "title": "Web Links",
    "content": ". | Lab 1: Audio-Tone Generation Using a Lookup Table with MPLAB® Harmony v3 | . ",
    ...
    "doc": "Audio Tone using text fil in SD card",
    "title": "Web Links",
    "content": ". | Lab 2: Audio-Tone Generation from a Text File Stored in an SD Card with MPLAB® Harmony v3 | . ",
    ...
    "doc": "Play WAV Audio File from SD Card",
    "title": "Web Links",
    "content": ". | Lab 4: Play a WAV Audio File from an SD Card with MPLAB® Harmony v3 | . ",
    ...
    "doc": "SD card Reader to load Audio Files",
    "title": "Web Links",
    "content": ". | Lab 3: SD Card Reader Support to Load Audio Files with MPLAB® Harmony v3 | . ",
    ...
    "doc": "SD Card Audio Player Reader Tutorial",
    "title": "Web Links",
    "content": ". | MPLAB® Harmony v3 SD Card Audio Player/Reader Tutorial on PIC32 MZ EF MCUs | . ",
    ...
    "doc": "Getting Started with MPLAB® Harmony v3 to Create a Web-Enabled Digital Photo Frame",
    "title": "Getting Started with MPLAB Harmony v3 to Create a Web-Enabled Digital Photo Frame",
    "content": "This tutorial is intended to show users how to create a web-enabled digital photo frame from scratch using MPLAB Harmony 3 and MPLAB Code Configurator (MCC) with Harmony 3. The project you create will run on the Curiosity PIC32MZ EF 2.0 Development Board (DM320209). This application will perform the following tasks: . | The photos will be hosted on the microSD Click board™ mounted on the mikroBUS™ 1 of the Curiosity 2.0 board. | Display photos from the SD card using the High-Performance 4.3” WQVGA Display Module with maXTouch® (AC320005-4) technology and the SSD1963 LCD Controller Graphics Card (AC320214). | Host an onboard webserver to display the same photos using your computer’s web browser, using the TCP/IP stack on the PIC32MZ2048EFM144, where the Ethernet MAC mounted is connected via RMII, with KSZ8061 PHY Daughter Board (AC320004-6) mounted on the Ethernet PHY Module of the Curiosity 2.0 board. | Console using the MCP2221 USB-to-UART/I2C converter from MikroElektronika (USB I2C Click). | . For more information refer the links below. ",
    "url": "http://localhost:4000/quick_docs/source/middleware/web_photo_frame/readme.html#getting-started-with-mplab-harmony-v3-to-create-a-web-enabled-digital-photo-frame",
    "relUrl": "/source/middleware/web_photo_frame/readme.html#getting-started-with-mplab-harmony-v3-to-create-a-web-enabled-digital-photo-frame"
  },"416": {
    "doc": "Getting Started with MPLAB® Harmony v3 to Create a Web-Enabled Digital Photo Frame",
    "title": " ",
    "content": " ",
    "url": "http://localhost:4000/quick_docs/source/middleware/web_photo_frame/readme.html",
    "relUrl": "/source/middleware/web_photo_frame/readme.html"
  },"417": {
    "doc": "Getting Started with MPLAB® Harmony v3 to Create a Web-Enabled Digital Photo Frame",
    "title": "Web Links",
    "content": ". | Getting Started with MPLAB® Harmony v3 to Create a Web-Enabled Digital Photo Frame | . ",
    "url": "http://localhost:4000/quick_docs/source/middleware/web_photo_frame/readme.html#web-links",
    "relUrl": "/source/middleware/web_photo_frame/readme.html#web-links"
  },"418": {
    "doc": "Getting Started with MPLAB® Harmony v3 to Create a Web-Enabled Digital Photo Frame",
    "title": "Reference Links",
    "content": "                . ",
    "url": "http://localhost:4000/quick_docs/source/middleware/web_photo_frame/readme.html#reference-links",
    "relUrl": "/source/middleware/web_photo_frame/readme.html#reference-links"
  },"419": {
    "doc": "Getting Started with MPLAB® Harmony v3 to Create a Web-Enabled Digital Photo Frame",
    "title": "Getting Started with MPLAB® Harmony v3 to Create a Web-Enabled Digital Photo Frame",
    "content": "                                                                                                      . ",
    ...
    "content": "This page contains quick documentation for MPLAB® Harmony 3 Middleware Libraries usage. | Getting Started with Harmony v3 Drivers and Middleware on PIC32MZ EF MCUs using FreeRTOS . | Getting Started with USB on SAM MCUs Using MPLAB Harmony v3 . | Rapid prototyping with Curiosity Nano Evaluation Kit using MPLAB Harmony v3 . | Digit Recognition AI/ML Application on SAM E51 IGAT CURIOSITY EVALUATION KIT Using MPLAB Harmony v3 . | Getting Started with MPLAB Harmony v3 to Create a Web-Enabled Digital Photo Frame . | Secure Boot on PIC32CM LS60 Curiosity Pro Evaluation Kit using MPLAB Harmony v3 . | . ",
    ...
    "doc": "Middleware Examples",
    "title": "TCP/IP",
    "content": ". | Create your first TCP/IP Application . | Harmony TCP/IP User Guide . | File Transfer Protocol Using MPLAB Harmony v3 TCP/IP Stack for SAM E54 MCU . | . ",
    ...
    "doc": "Application migration from 8 bit AVR to 32 bit SAM D21",
    "title": "Software/Tools Used:",
    "content": "This project has been verified to work with the following versions of software tools: . | MPLAB Harmony v3 “csp” repo v3.18.5 | MPLAB Code Configurator Plugin v5.5.1 | MPLAB X IDE v6.20 | MPLAB XC32 Compiler v4.40 | Any Serial Terminal application like Tera Term terminal application. | . Because Microchip regularly update tools, occasionally issue(s) could be discovered while using the newer versions of the tools. If the project doesn’t seem to work and version incompatibility is suspected, It is recommended to double-check and use the same versions that the project was tested with. ",
    ...
    "doc": "Application migration from 8 bit AVR to 32 bit SAM D21",
    "title": " ",
    "content": "Overview . This migration guide uses the AVR ATMega4809 application which helps in “Getting Started with UART on AVR”. | Click Here to download the application. | . The AVR ATMega4809 application shows how to implement a command line interface. This way, the microcontroller can receive control commands via the USART. In this use case, an LED is controlled using commands sent from the MPLAB Data Visualizer. The application flow is as follows: . | Configures the system clock The clock is configured to 1 MHz using 16 MHz Internal Oscillator . | Configures USART3 USART3 is configured for 9600 baud rate and the standard 8-N-1 (eight data bits, no parity bit and one Stop bit) frame format. | Configures pins The USART TX, RX pins and LED pin are configured . | Implements STDIO receive and send functions STDIO library is implemented to receive and send commands from serial terminal . | Reads and execute valid commands Receives command from serial terminal and executes it . | . Follow the below steps to get started migrating to SAMD21 and later extend the functionality by adding more peripherals. 1. Install MCC . | Install the MPLAB® Code Configurator (MCC) Plug-in in the MPLAB X IDE if not installed. | Verify the MPLAB® Code Configurator (MCC) Plug-in is installed. | Launch MPLAB X IDE from the Windows® Start Menu. Close all the projects and files that are currently open. | Go to Tools &gt; Embedded. | You will see MPLAB® Code Configurator v5 in the menu. | . | . 2. Create MPLAB Harmony v3 Project . | Select File &gt; New Project from the main IDE menu. | In the Categories pane of the New Project dialog window, select Microchip Embedded. In the Projects pane, select Application Project(s), then click Next. | In the Select Device pane, select ATSAMD21G17D as the target device in the Device edit box and select Next. | In the Select Compiler pane of the New Project dialog window, select the latest XC32 Compiler, then click Next. | In the Project Settings window, apply the following settings: . | Project Name: enter the project’s logical name as “atmega4809_to_sam_d21_cnano”. This is the name that will be shown from within the MPLAB X IDE. | Project Location: indicates the path to the root folder of the new project. All project files will be placed inside this folder. The project location can be any valid path, for example: &lt;your project path&gt;/atmega4809_to_sam_d21_migration. | Project Folder: indicates the name of the MPLAB X .X folder. It will automatically be created by using the Project Name. | click Finish to launch MCC. | The MCC plugin’s main window for the project will be displayed as shown in the following image . | . | . | . 3. Configure Clock . The SAM D21 family of microcontrollers (MCUs) contains a sophisticated clock distribution system designed to give maximum flexibility to the user application. The clock system allows the tuning of the performance and power consumption of the device in a dynamic manner. The MCC provides an easy to use UI (User Interface) window, and a Clock Easy View window to configure the system and peripheral clocks. | Launch Clock Easy View by going to Project Graph &gt; Plugins menu and then select Clock Configuration. | In the Clock Easy View, SAM D21 can operate at maximum 48 MHz, therefore Main Clock is set to 48 MHz. | Change the Main Clock to 1MHz | The Open loop Digital Frequency Locked Loop (DFLL 48 MHz) is configured and enabled to run the main clock. The configured DFLL is fed as input to the GCLK generator ‘0’ and a suitable clock divider (48) and masker must be selected to achieve a maximum frequency of 1 MHz. Refer to the following figure to configure the main clock to run at 1MHz . | MCC clock easy view provides all the clock options available in the SAMD21 in a UI, which makes easier to configure the clock whenever necessary. | . 4. Add SERCOM (USART) Peripheral . MCC Graphical User Interface helps in selecting and configuring the peripherals needed by the project. It lists all the peripherals available in SAMD21 in an Device Resources tab. | Click on the Device Resources tab in the left pane in the MPLAB® Code Configurator (MCC) window. Expand Harmony &gt; Peripherals &gt; SERCOM. | Double click or drag and drop SERCOM5 to add the USART Peripheral Library (PLIB) to the project graph. Note: SAM D21 Curiosity Nano On-Board Nano Debugger also includes a Virtual Com port which is routed to SERCOM5, therefore in this application, SERCOM5 is chosen. | Select the SERCOM5 Peripheral Library in the project graph. Verify that the default “SERCOM Operation Mode” configuration is set as USART and configure 9600 baud rate and then select SERCOM PAD[2] in Recieve Pinout and the standard 8-N-1 (eight data bits, no parity bit and one Stop bit) frame format. | . 5. Configuring USART pins using MCC PIN Configurator . The Pin Manager consists of Pin Settings, the Pin Diagram, and the Pin Table tabs, which enables users to configure (assign peripheral function, set pin direction, configure pull-up or pull-down and so on) and map the I/O pins. The following color combinations are associated with the pins in the graphical or table View: . | Gray: This pin is not usable in the selected configuration, and there is no enabled module which has any functionality on that pin. The grayed-out locks on a white background indicates the pins that are locked out by selected system functions. | Blue: This pin is available and can be allocated to a module. | Green (with a lock): This pin is allocated and selected for a module. The name displayed against the pin is either the name of the pin in the module’s context or a custom name entered. | Open the Pin Configuration tabs by clicking on Project Graphs &gt; Plugins &gt; Pin Configuration. | Launching Pin configuration opens Pin Settings, the Pin Diagram, and the Pin Table tabs. | Select the MCC Pin Table tab and then scroll down to the SERCOM5 module as shown below. | Enable USART_TX on PA22 (Pin #31) | Enable USART_RX on PB22 (Pin #37) . | . 6. Generate Code . | Now, generate the code by using MCC. From the left side tab Resource Management [MCC], go to Project Resources and then click on the Generate button. | Navigate to the Projects tab in MPLAB X IDE to view the project tree structure. | Examine the generated code as shown below. | MCC will include all the MPLAB Harmony library files and generate the code based on the MCC selections. The generated code would add files and folders to your Harmony project as shown. Among the generated code, notice the Peripheral Library (PLIB) files generated for SERCOM 5 (as Universal Synchronous Asynchronous Receiver Transmitter (USART)), Clock and PORT peripherals. | . 7. Add Code . | Navigate to the Projects tab in MPLAB X IDE and select main.c, add below code snippet in main function to print “Hello World” string on the serial terminal. uint8_t welcomeData[] = \\\"Hello World\\r\\n\\\"; while ( true ) { SERCOM5_USART_Write(&amp;welcomeData[0],sizeof(welcomeData)); } . | . 8. Build and Program . | Before proceeding to Build and program, set up the compiler toolchain. Click on the Projects tab on the top left pane in MPLAB X IDE. Right click on the project name atmega4809_to_sam_d21_cnano and go to Properties. | Make sure that XC32 (v4.40) is selected as the Compiler Toolchain for XC32. Click on Apply and then click on OK. | Clean and build your application by clicking on the Clean and Build button as shown below. | Program your application to the device by clicking on the Make and Program button as shown below. | The lab should build and program successfully. | . 9. Verify “Hello World” output . | Now, open the Tera Term terminal application on your PC (from the Windows® Start menu by pressing the Start button). Select the Serial Port as shown below. | Change the baud rate to 9600. | You should see the “Hello World” message displayed on the terminal as shown below. | . You successfully completed printing the “Hello World” message on serial terminal. Let us continue and extend the functionality of the application as below. 10. Configure/Enable Formatted STDIO, USART Receive and SWITCH/LED functionality . | Configure STDIO Library to use printf and scanf function to write and read data from the serial terminal respectively. | Receive the command from serial terminal and control the LED0 on the SAM D21 Curiosity evaluation kit. | Use Switch SW0 on the SAM D21 Curiosity Evaluation Kit to toggle the LED twice when it is pressed. External Interrupt controller (EIC) and Systick peripherals are used to achieve this. | If you closed MCC accidently and would like to open it again, go to Tools &gt; Embedded &gt; MPLAB® Code Configurator v5 in MPLAB X IDE. | In the Project Graph, Select SERCOM5. Right click on yellow diamond and select consumer as STDIO as shown below . | Select the MCC Pin Settings tab and then scroll down to the PORT pin PB10 (Pin Number 19) in the Pin ID column and configure PB10 as an output pin for LED functionality as shown below. | Select the Pin Settings tab and then scroll down to the PORT pin PB11 (Pin Number 20) in the Pin ID column and configure PB11 as an external interrupt pin for switch functionality as shown below. Internal pull-up is enabled to avoid false edge detection as there is no external pull-up on the SAM D21 Curiosity Nano Evaluation Kit. | Select the Project Graph tab. | Under the Device Resources tab, expand Harmony &gt; Peripheral &gt; EIC. Select and double click on EIC to add the EIC module to the project. | Configure the EIC block to generate an interrupt every time the user presses the switch SW0 as shown below and enable filter functionality to avoid electrical noise on the switch pin. | Enable Systick to create a delay for toggling LED0, click on System in Project Graph and Configure as below. | Click on the Generate button to generate the code. | Navigate to the Projects tab in MPLAB X IDE and select main.c, add below code snippet to receive the command from serial terminal and a function to control the LED0 on the SAM D21 Curiosity Nano Evaluation Kit. | In main.c, add the below function above “main” function . #include &lt;string.h&gt; void executeCommand(char *command) { if(strcmp(command, \\\"ON\\\") == 0) { LED_Clear(); printf(\\\"OK, LED ON.\\r\\n\\\"); } else if (strcmp(command, \\\"OFF\\\") == 0) { LED_Set(); printf(\\\"OK, LED OFF.\\r\\n\\\"); } else { printf(\\\"Incorrect command.\\r\\n\\\"); } } . | Move “SERCOM5_USART_Write” function above while loop and add scanf inside the while loop as shown below. | Clean and build your application by clicking on the Clean and Build button. | Now, open the Tera Term terminal application on your PC. Enable Local echo in Setup &gt; Terminal as shown below. | . 11. Verify Formatted STDIO, USART Receive and SWITCH/LED functionality . | Program your application to the device by clicking on the Make and Program button. The lab should build and program successfully. | In Tera Term you should see “Hello World” message displayed. | Type ON in serial terminal and press Enter to turn on LED0 on SAMD21 Curiosity Nano kit and Type OFF in serial terminal and press Enter to turn off LED0 on SAMD21 Curiosity Nano Evaluation Kit. | Switch SW0 is configured as interrupt using EIC peripheral, therefore register a call back in main function. Whenever user presses the switch, a callback will be notified and inside the call back, toggle the LED0 twice. | In main.c file, inside main function, add the below code. EIC_CallbackRegister(EIC_PIN_11,EIC_User_Handler, 0); SYSTICK_TimerStart(); . | In main.c, add the below code above main function . static void EIC_User_Handler(uintptr_t context) { uint8_t i = 0; while(i&lt;4){ LED_Toggle(); SYSTICK_DelayMs(500); i++; } } . | Clean and build your application by clicking on the Clean and Build button. | Program your application to the device by clicking on the Make and Program button. | Press the Switch SW0 on SAM D21 Curiosity Nano Evaluation Kit and observe LED0 Toggling twice at 500ms rate. | . You successfully completed controlling the LED0 on the SAMD21 Curiosity Nano Evaluation Kit by receiving the commands from the serial terminal through USART and also toggled the LED0 on Switch SW0 press using EIC and Systick peripheral. 12. Extend application to configure SPI loopback using DMA based Transfers . Let us extend the functionality and add Serial Peripheral Interface (SPI) to perform a Self-Loopback test and add Direct memory address (DMA) to send the status of the SPI Transfer to the terminal without using CPU. | Select the Project Graph tab. Under the Device Resources tab, expand Peripheral &gt; SERCOM. Select and double click on SERCOM1 to add the SPI module to the project. | In Project Graph select SERCOM1 and configure as below . | Open Pin Table, Select SERCOM1 and configure the pins as shown below . | Launch DMA Configuration from Project Graph &gt; Plugins &gt; DMA Configuration. | Click on ADD Channel and Select SERCOM5_Transmit to configure the DMA . | Click on the Generate button to generate the code. | In main.c, Add below code snippet . SERCOM1_SPI_WriteRead(&amp;txData[0], sizeof(txData), &amp;rxData[0], sizeof(rxData)); /* Compare received data with the transmitted data */ if ((memcmp(txData, rxData, sizeof(txData)) == 0)) { /* Pass: Received data is same as transmitted data */ DMAC_ChannelTransfer(DMAC_CHANNEL_0, \\\"Received SPI Valid Data\\r\\n\\\", \\\\ (const void *)&amp;(SERCOM5_REGS-&gt;USART_INT.SERCOM_DATA), \\\\ 25); } else { /* Fail: Received data is not same as transmitted data */ DMAC_ChannelTransfer(DMAC_CHANNEL_0, \\\"Received Invalid SPI Data\\r\\n\\\", \\\\ (const void *)&amp;(SERCOM5_REGS-&gt;USART_INT.SERCOM_DATA), \\\\ 27); } . | Add below code snippet above main function . uint8_t txData[] = \\\"SELF LOOPBACK DEMO FOR SPI!\\\"; uint8_t rxData[sizeof(txData)]; . | Clean and build your application by clicking on the Clean and Build button. | Program your application to the device by clicking on the Make and Program button. | . 13. Verify extended functionality - SPI loopback . | Connect PA16 and PA19 on SAM D21 Curiosity Nano Evaluation Kit using a connecting wire. | Open Tera Term and observe the data as shown below. | You can still control the LED0 by sending the commands through serial terminal. | . ",
    "url": "http://localhost:4000/quick_docs/source/migration/atmega4809_to_samd21_migration/readme.html",
    "relUrl": "/source/migration/atmega4809_to_samd21_migration/readme.html"
  },"454": {
    "doc": "Application migration from 8 bit AVR to 32 bit SAM D21",
    ...
    "doc": "Build MPLAB Harmony v3 project with ARM GCC toolchain in MPLAB X IDE",
    "title": "Software/Tools Used:",
    "content": "This project has been verified to work with the following versions of software tools: . | MPLAB Harmony v3 “csp” repo v3.18.5 | MPLAB Harmony v3 “csp_apps_sam_d21_da1” repo v3.4.0 | MPLAB Code Configurator Plugin v5.5.1 | MPLAB X IDE v6.20 | ARM GNU Toolchain v6.3.1 | MPLAB XC32 Compiler v4.40 | Any Serial Terminal application like Tera Term terminal application. | . Because Microchip regularly update tools, occasionally issue(s) could be discovered while using the newer versions of the tools. If the project doesn’t seem to work and version incompatibility is suspected, It is recommended to double-check and use the same versions that the project was tested with. ",
    ...
    "content": "This page acts as a reference for migrating applications from 8-bit PIC Microcontroller (MCU) to 32-bit SAM MCU. This page shows how to migrate an application from PIC18F47Q10 MCU to SAMD21G17D MCU with the help of an example. For the migration to a 32-bit MCU, the application uses SAM D21 Curiosity Nano Evaluation Kit and is developed on MPLAB® Harmony v3 software framework. The SAM D21 Curiosity Nano Evaluation Kit is a hardware platform to evaluate the SAMD21G17D microcontroller (MCU). It is supported by the MPLAB® X Integrated Development Environment (IDE) and MPLAB Harmony v3 software development framework. The evaluation kit provides easy access to the features of the SAM D21 MCU to integrate the device into a custom design. Because the evaluation kit contains an On-Board Nano Debugger for programming and debugging, no external tools are necessary to program the SAMD21G17D device. The evaluation kit is compatible with Curiosity Nano Base board (Part Number - AC164162) which allows you to quickly scale and prototype your next innovative design using the SAMD21G17D MCU. MPLAB® Harmony v3 is a flexible, fully integrated embedded software development framework for 32-bit microcontrollers (MCUs) and microprocessors (MPUs). MPLAB Harmony v3 includes the MPLAB Code Configurator (MCC) tool, a set of modular Peripheral Libraries (PLIBs), drivers, system services, middleware, and numerous example applications, all of which are designed to help quickly and easily develop powerful and efficient embedded software for Microchip’s 32-bit PIC® and SAM devices. This migration guide refers an existing application Getting Started with UART Using EUSART on PIC18 developed on PIC18F47Q10 Curiosity Nano evaluation kit using MPLAB® Code Configurator (MCC) and discuss steps to migrate the existing application to SAM D21 Curiosity Nano Evaluation Kit using MPLAB® Code Configurator (MCC). The application is further extended by adding more peripheral specific functionality. The application developed on SAM D21 MCU will utilize: . | PORT PLIB to control the LED. | External Interrupt Controller (EIC) PLIB and Systick PLIB to toggle the LED on SWITCH press event | SERCOM (as Universal Synchronous Asynchronous Receiver Transmitter (USART)), STDIO Library and Direct Memory Access (DMA) PLIBs to print the Info messages on a COM (serial) port terminal application running on a PC and to receive command from serial terminal. | SERCOM (as SPI) to run a self-loopback test. | . Two ways to use this guide: . | Create the project from scratch: . | Follow step-by-step instructions below. | . | Use the solution project as an example: . | Build the solution project and program it to the SAM D21 Curiosity Nano Evaluation Kit to observe the expected behavior. | . | . This following bullet points provides links to the topics: . | Hardware Used | Software/Tools Used | Hardware Setup | Description . | Overview | Install MCC | Create MPLAB Harmony v3 Project | Configure Clock | Add SERCOM (USART) Peripheral | Generate Code | Add Code | Build and Program | Verify “Hello World” output | Configure/Enable Formatted STDIO, USART Receive and SWITCH/LED functionality | Verify Formatted STDIO, USART Receive and SWITCH/LED functionality | Extend application to configure SPI loopback using DMA based Transfers | Verify extended functionality - SPI loopback | . | Results | Analysis | Conclusions | . ",
    ...
    "doc": "Arm TrustZone Getting Started Application on PIC32CK SG01 MCU",
    "title": "Arm TrustZone Getting Started Application on  PIC32CK SG01 MCU",
    "content": "This tutorial shows you how to create an Arm TrustZone feature application on PIC32CK SG01 microcontroller (MCU) using the MPLAB Harmony v3 software framework. The PIC32CK SG01 MCU is the implementation of the Arm TrustZone for Armv8-M devices. TrustZone technology for an Armv8-M device is based on specific hardware that is implemented in the Arm Cortex®-M33 core, which is combined with a dedicated Secure instructions set. It allows the creation of multiple software security domains that restrict access to selected memory, peripherals, and I/O to trusted software without compromising the system’s performance. The TrustZone technology enables secure and non-secure code to run on a single MCU. MPLAB Harmony v3 is a flexible, fully integrated embedded software development framework for 32-bit microcontrollers (MCUs) and microprocessors (MPUs). MPLAB Harmony v3 includes the MPLAB Code Configurator (MCC) tool, a set of modular Peripheral Libraries (PLIBs), drivers, system services, middleware, and numerous example applications, all of which are designed to help you quickly and easily develop powerful and efficient embedded software for Microchip’s 32-bit PIC and SAM devices. Also, MPLAB Harmony v3 provides a TrustZone environment to develop security applications on different secured MCUs and MPUs like SAM L11, SAM A5D2 and SAM A5D4. The application makes use of the PIC32CK SG01 Curiosity Ultra Development Board and the I/O1 Xplained Pro Extension Kit (sold separately). The application includes Basic and Extended functionalities. Basic application: . | The Secure mode application toggles an LED (LED0 toggles when the switch SW0 is pressed) on a timeout basis and the periodicity of the timeout will change from 500 milliseconds to one second, two seconds, four seconds, and back to 500 milliseconds every time you press the switch SW0 on the PIC32CK SG01 Curiosity Ultra Development Board. | The Non-secure application requests the Secure mode application, reads the LED toggling rate, and prints on the serial terminal. The LED toggling rate data is transferred to the Non-secure mode application when it requests to Secure application through Non-Secure Callables (NSC). | . Extended application: . | The Secure mode application reads the current room temperature from the temperature sensor on the I/O1 Xplained Pro Extension Kit every 500 milliseconds. Further, the application writes the temperature readings to EEPROM and reads when a request is received from the Non-secure mode application. Also, a green LED (LED0) is toggled every time the temperature display request is received from the Non-secure mode application. The periodicity of the temperature values reading can be changed to 1 second, 2 seconds, 4 seconds, and back to 500 milliseconds whenever the user presses the switch SW0 on the PIC32CK SG01 Curiosity Ultra Development Board. The temperature readings are transferred to the Non-secure mode application when it requests to Secure the application through Non-Secure Callables (NSC). | The Non-secure mode application requests the Secure mode application the temperature values and prints them on a serial console once it receives from the Secure mode application. Further, when it gets a request from the user (in the form of a key press on the serial console), it will request the Secure mode application to retrieve the last five stored temperature values in the EEPROM. The Non-secure application prints the last five stored temperature values on the console. Also, a red LED (LED1) is toggled every time the temperature values are read from EEPROM. | . The application has two projects on Secure and Non-secure modes of PIC32CK SG01, that work together on the same MCU and offer security isolation between the trusted and the non-trusted resources of the device. The Secure mode application reads the current room temperature from the temperature sensor on the I/O1 Xplained Pro Extension Kit every 500 milliseconds. Additionally, the secure application writes the temperature readings to EEPROM and reads when a request is received from the Non-secure mode application. Also, an LED (LED0) is toggled every time the temperature is displayed on the serial console. The periodicity of the temperature values reading can be changed to 1 second, 2 seconds, 4 seconds, and back to 500 milliseconds every time the user presses the switch SW0 on the PIC32CK SG01 Curiosity Ultra Development Board. The temperature readings are transferred to a Non-secure mode application when it requests to secure application through Non-Secure Callables (NSC). By default LED toggling rate is displayed on the terminal, by pressing the switch SW1, the temperature sampling rate is displayed. Switch SW1 press interrupt to toggle from Basic Functionality to Extended Functionality and vice-versa. The Non-secure mode application requests the Secure mode application to get the current temperature values and the Non-secure mode application prints them on a serial console. Further, when it receives a request from the user (in the form of a key press on the serial console), it requests a Secure mode application to retrieve the last five stored temperature values in the EEPROM. The Non-secure application prints the last five stored temperature values on the console. The application you create will utilize: . | Secure PORT Pin to toggle the LED (By default, all PORT pins are secure) | Secure SERCOM (configured as I²C) PLIB to read the temperature from a temperature sensor | Secure Real-Time Clock (RTC) PLIB to periodically sample temperature sensor data | Mix-Secure peripheral External Interrupt Controller (EIC) PLIB to change the periodicity of temperature sensor data read using switch SW0 press interrupt and switch SW1 press interrupt to toggle from Basic Functionality to Extended Functionality and vice-versa. | Non-secure SERCOM (configured as Universal Synchronous Asynchronous Receiver Transmitter (USART)) and Non-secure Direct Memory Access (DMA) PLIBs to print the temperature values on a COM (serial) port terminal application running on a PC | Non-secure PORT Pins (USART Pins only) to communicate with the serial terminal | In the process, the lab will also demonstrate the use of callback functions. | . For more information refer the links below. ",
    "url": "http://localhost:4000/quick_docs/source/peripheral/arm_trustzone_pic32ck_sg01_getting_started/readme.html#arm-trustzone-getting-started-application-on--pic32ck-sg01-mcu",
    "relUrl": "/source/peripheral/arm_trustzone_pic32ck_sg01_getting_started/readme.html#arm-trustzone-getting-started-application-on--pic32ck-sg01-mcu"
  },"559": {
    "doc": "Arm TrustZone Getting Started Application on PIC32CK SG01 MCU",
    "title": " ",
    "content": " ",
    "url": "http://localhost:4000/quick_docs/source/peripheral/arm_trustzone_pic32ck_sg01_getting_started/readme.html",
    "relUrl": "/source/peripheral/arm_trustzone_pic32ck_sg01_getting_started/readme.html"
  },"560": {
    "doc": "Arm TrustZone Getting Started Application on PIC32CK SG01 MCU",
    "title": "Web Links",
    "content": ". | Arm® TrustZone® Technology Getting Started Application on PIC32CK SG01 (Cortex®-M33) MCUs | . ",
    "url": "http://localhost:4000/quick_docs/source/peripheral/arm_trustzone_pic32ck_sg01_getting_started/readme.html#web-links",
    "relUrl": "/source/peripheral/arm_trustzone_pic32ck_sg01_getting_started/readme.html#web-links"
  },"561": {
    "doc": "Arm TrustZone Getting Started Application on PIC32CK SG01 MCU",
    "title": "Reference Links",
    "content": "                . ",
    "url": "http://localhost:4000/quick_docs/source/peripheral/arm_trustzone_pic32ck_sg01_getting_started/readme.html#reference-links",
    "relUrl": "/source/peripheral/arm_trustzone_pic32ck_sg01_getting_started/readme.html#reference-links"
  },"562": {
    "doc": "Arm TrustZone Getting Started Application on PIC32CK SG01 MCU",
    "title": "Arm TrustZone Getting Started Application on PIC32CK SG01 MCU",
    "content": "                                                                                                      . ",
    ...
    "doc": "Low Power with PLIBs on PIC32CM LE00 MCU",
    "title": "Low Power Application on PIC32CM LE00 (Cortex M23) MCU Using MPLAB® Harmony v3 Peripheral Libraries",
    "content": "The PIC32CM LE00 is a 32-bit Arm® Cortex®-M23-based microcontroller that provides features to reduce power consumption through different Sleep modes, such as Idle and Standby. | In Idle mode, the CPU is stopped and optionally, some synchronous clock domains are stopped, depending on the IDLE argument. The regulator operates in Normal mode. This mode allows power optimization with a fast wake-up time. | In Standby mode, all clock sources are stopped, except those that are kept running if requested by a running module or have the ONDEMAND bit set to zero. The regulator operates in Low Power mode. Before entering Standby mode the user must make sure that a significant amount of clocks and peripherals are disabled so that the voltage regulator is not overloaded. This mode allows the device to consume the lowest power with little overhead on wake-up time. | . The Power Manager (PM) module is responsible for controlling the Low Power modes. Additionally, the PIC32CM LE00 MCU provides SleepWalking. SleepWalking is the capability for a device to temporarily wake up clocks for the peripheral to perform a task without waking up the CPU in STANDBY sleep mode. The application makes use of the PIC32CM LE00 Curiosity Pro Evaluation Kit, and the I/O1 Xplained Pro Extension Kit (sold separately). The application is developed on the MPLAB Harmony v3 software framework. MPLAB Harmony v3 is a modular framework that provides interoperable firmware libraries for application development on 32-bit MCUs and MPUs. It includes an easy-to-use Graphical User Interface (GUI) (MHC) for selecting, configuring, and generating starter codes, peripheral libraries, and middleware (USB, TCP/IP, Graphics, and so on). On power-up, the application prints a menu on a PC serial terminal. The menu provides options to measure the device’s power consumption in Sleep modes. Once the option is selected, the application sets up the EIC peripheral clock source and goes to Standby Sleep mode to enable measurement modes. In this training module, The power consumption of the PIC32CM LE00 Curiosity Pro Evaluation Kit is measured using the tool: . | Data Visualizer - A software tool | . The steps to connect and measure the power consumption using these tools are provided in the following sections. Power Measurement Mode By default, the application is running with the device in Standby Sleep mode. While the device is in Standby Sleep mode, the user can measure the device’s power consumption by following the instructions provided in the following sections. The device wakes up from Standby mode and enters Active mode when you cover the light sensor (by placing a hand over it, for example) on the I/O1 Xplained Pro Extension Kit. Here, you can observe the transition of the device’s power consumption from Standby Sleep mode to Active mode on the Data Visualizer tool. The application prints the room temperature on a serial terminal, and the device goes back to Standby Sleep mode. The LED0 on the PIC32CM LE00 Curiosity Pro Evaluation Kit is toggled every time the serial console displays the temperature. When you press the switch button SW1, the application switches from Standby Sleep mode to Idle Sleep mode. Here, you can observe the transition of the device’s power consumption from Standby Sleep mode to Active mode and from Active mode to Idle Sleep mode. At this point, you can measure the device’s power consumption in Idle Sleep mode by following the instructions provided in the following sections. The device wakes up from Idle mode and enters Active mode when you cover the light sensor (by placing a hand over it, for example) on the I/O1 Xplained Pro extension Kit. Here, you can observe the transition of the device’s power consumption from Idle Sleep mode to Active mode on the Data Visualizer tool. The application prints the room temperature on a serial terminal, and the device goes back to Standby Sleep mode. The LED0 on the PIC32CM LE00 Curiosity Pro Evaluation Kit is toggled every time the serial console displays the temperature. By default, the application is running with the device in Standby Sleep mode, and the device wakes up from Standby Sleep mode when you press a switch on the Evaluation board. The application switches the device’s Sleep mode between Standby Sleep mode and Idle Sleep mode whenever you press the SW1 switch. Also, the device wakes up from Standby mode or Idle mode when you cover the light sensor by placing your hand over it, prints the wake-up reason message, and goes back to Sleep mode. The application you create will utilize the following peripherals: . | SERCOM5 (as I²C) peripheral library to read the temperature from the temperature sensor. | Real-Time Clock (RTC) peripheral library to periodically generate an event for the ADC to sample the light sensor. | SERCOM3 (as Universal Synchronous Asynchronous Receiver Transmitter (USART)) peripheral library to print messages on a serial console running on a computer. | PORT peripheral library to toggle the LED0. | Analog to Digital Converter (ADC) peripheral library to sample the light sensor analog input and detect whether the light sensor is covered or not. | PM peripheral library to configure Low Power modes. | External Interrupt Controller (EIC) peripheral library to control the user button SW1. | EVSYS peripheral library to trigger the start of the ADC conversion on every RTC compare match event. The EVSYS allows for peripheral-to-peripheral communication without CPU intervention. This reduces the burden on the CPU and other resources when compared to conventional interrupt-based systems. | . For more information refer the links below. ",
    "url": "http://localhost:4000/quick_docs/source/peripheral/pic32cm_le00_low_power/readme.html#low-power-application-on-pic32cm-le00-cortex-m23-mcu-using-mplab-harmony-v3-peripheral-libraries",
    "relUrl": "/source/peripheral/pic32cm_le00_low_power/readme.html#low-power-application-on-pic32cm-le00-cortex-m23-mcu-using-mplab-harmony-v3-peripheral-libraries"
  },"569": {
    "doc": "Low Power with PLIBs on PIC32CM LE00 MCU",
    "title": " ",
    "content": " ",
    "url": "http://localhost:4000/quick_docs/source/peripheral/pic32cm_le00_low_power/readme.html",
    "relUrl": "/source/peripheral/pic32cm_le00_low_power/readme.html"
  },"570": {
    "doc": "Low Power with PLIBs on PIC32CM LE00 MCU",
    "title": "Web Links",
    "content": ". | Low Power Application on PIC32CM LE00 (Cortex M23) MCUs Using MPLAB® Harmony v3 Peripheral Libraries | . ",
    "url": "http://localhost:4000/quick_docs/source/peripheral/pic32cm_le00_low_power/readme.html#web-links",
    "relUrl": "/source/peripheral/pic32cm_le00_low_power/readme.html#web-links"
  },"571": {
    "doc": "Low Power with PLIBs on PIC32CM LE00 MCU",
    "title": "Reference Links",
    "content": "                . ",
    "url": "http://localhost:4000/quick_docs/source/peripheral/pic32cm_le00_low_power/readme.html#reference-links",
    "relUrl": "/source/peripheral/pic32cm_le00_low_power/readme.html#reference-links"
  },"572": {
    "doc": "Low Power with PLIBs on PIC32CM LE00 MCU",
    ...
    "doc": "Getting Started with PLIBs on SAM9X60 MPUs",
    "title": "Web Links",
    "content": ". | Getting Started with Harmony v3 Peripheral Libraries on SAM9X60 EK Evaluation Board | Getting Started with Harmony v3 Peripheral Libraries on SAM9X60 Curiosity Developmen Board | . ",
    ...
    "doc": "Getting Started with PLIBs on SAMA5D29 MPUs",
    "title": "Getting Started with Harmony v3 Peripheral Libraries on SAMA5D29 MPUs",
    "content": "In this tutorial, you will download, configure, and build an MPLAB® Harmony 3 Software Framework application to run on the SAM9X60-EK Evaluation Kit using the MPLAB X Integrated Development Environment (IDE) in Debug mode. Once the application has been fully developed, the application is cleaned and built for production. The resulting binary image (harmony.bin) is written to Non-Volatile Memory (NVM), such as SD memory card, eMMC, NAND, or NOR Flash memories. The harmony.bin binary image is read from NVM by the second-stage bootloader, at91bootstrap, which is also written to NVM. However, at91boostrap must be configured and built for a given NVM. For more information refer the links below. ",
    "url": "http://localhost:4000/quick_docs/source/peripheral/sama5d29_getting_started/readme.html#getting-started-with-harmony-v3-peripheral-libraries-on-sama5d29-mpus",
    "relUrl": "/source/peripheral/sama5d29_getting_started/readme.html#getting-started-with-harmony-v3-peripheral-libraries-on-sama5d29-mpus"
  },"594": {
    "doc": "Getting Started with PLIBs on SAMA5D29 MPUs",
    "title": " ",
    "content": " ",
    "url": "http://localhost:4000/quick_docs/source/peripheral/sama5d29_getting_started/readme.html",
    "relUrl": "/source/peripheral/sama5d29_getting_started/readme.html"
  },"595": {
    "doc": "Getting Started with PLIBs on SAMA5D29 MPUs",
    "title": "Web Links",
    "content": ". | Getting Started with Harmony v3 Peripheral Libraries on SAMA5D29 MPUs | . ",
    "url": "http://localhost:4000/quick_docs/source/peripheral/sama5d29_getting_started/readme.html#web-links",
    "relUrl": "/source/peripheral/sama5d29_getting_started/readme.html#web-links"
  },"596": {
    "doc": "Getting Started with PLIBs on SAMA5D29 MPUs",
    "title": "Reference Links",
    "content": "                . ",
    "url": "http://localhost:4000/quick_docs/source/peripheral/sama5d29_getting_started/readme.html#reference-links",
    "relUrl": "/source/peripheral/sama5d29_getting_started/readme.html#reference-links"
  },"597": {
    "doc": "Getting Started with PLIBs on SAMA5D29 MPUs",
    "title": "Getting Started with PLIBs on SAMA5D29 MPUs",
    "content": "                                                                                                      . ",
    "url": "http://localhost:4000/quick_docs/source/peripheral/sama5d29_getting_started/readme.html",
    "relUrl": "/source/peripheral/sama5d29_getting_started/readme.html"
  },"598": {
    "doc": "Getting Started with PLIBs on SAMA7G54 MPUs",
    "title": "Getting Started with Harmony v3 Peripheral Libraries on SAMA7G54 MPUs",
    "content": "In this tutorial, you will download, configure, and build an MPLAB® Harmony 3 Software Framework application to run on the SAM9X60-EK Evaluation Kit using the MPLAB X Integrated Development Environment (IDE) in Debug mode. Once the application has been fully developed, the application is cleaned and built for production. The resulting binary image (harmony.bin) is written to Non-Volatile Memory (NVM), such as SD memory card, eMMC, NAND, or NOR Flash memories. The harmony.bin binary image is read from NVM by the second-stage bootloader, at91bootstrap, which is also written to NVM. However, at91boostrap must be configured and built for a given NVM. For more information refer the links below. ",
    "url": "http://localhost:4000/quick_docs/source/peripheral/sama7g54_getting_started/readme.html#getting-started-with-harmony-v3-peripheral-libraries-on-sama7g54-mpus",
    "relUrl": "/source/peripheral/sama7g54_getting_started/readme.html#getting-started-with-harmony-v3-peripheral-libraries-on-sama7g54-mpus"
  },"599": {
    "doc": "Getting Started with PLIBs on SAMA7G54 MPUs",
    "title": " ",
    "content": " ",
    "url": "http://localhost:4000/quick_docs/source/peripheral/sama7g54_getting_started/readme.html",
    "relUrl": "/source/peripheral/sama7g54_getting_started/readme.html"
  },"600": {
    "doc": "Getting Started with PLIBs on SAMA7G54 MPUs",
    "title": "Web Links",
    "content": ". | Getting Started with Harmony v3 Peripheral Libraries on SAMA7G54 MPUs | . ",
    "url": "http://localhost:4000/quick_docs/source/peripheral/sama7g54_getting_started/readme.html#web-links",
    "relUrl": "/source/peripheral/sama7g54_getting_started/readme.html#web-links"
  },"601": {
    "doc": "Getting Started with PLIBs on SAMA7G54 MPUs",
    "title": "Reference Links",
    "content": "                . ",
    "url": "http://localhost:4000/quick_docs/source/peripheral/sama7g54_getting_started/readme.html#reference-links",
    "relUrl": "/source/peripheral/sama7g54_getting_started/readme.html#reference-links"
  },"602": {
    "doc": "Getting Started with PLIBs on SAMA7G54 MPUs",
    ...
    "doc": "Getting Started with Drivers on SAM C2x MCUs Using FreeRTOS",
    "title": "Web Links",
    "content": ". | Getting Started with MPLAB® Harmony v3 Drivers on SAM C21 MCUs Using FreeRTOS | . ",
    ...
    "doc": "Getting Started with Drivers on SAM D21 MCUs Using FreeRTOS",
    "title": "Web Links",
    "content": ". | Getting Started with MPLAB® Harmony v3 Drivers on SAM D21 MCUs Using FreeRTOS | . ",
    ...
    "doc": "Getting Started with Drivers on SAM E5x MCUs Using FreeRTOS",
    "title": "Web Links",
    "content": ". | Getting Started with MPLAB® Harmony v3 Drivers on SAM E54 MCUs Using FreeRTOS | . ",
    ...
    "content": "This tutorial shows you how to use the MPLAB Code Configurator (MCC) to create an application that gets you started in developing applications on SAM E70/S70/V70/V71 MCUs using the MPLAB Harmony v3 software framework. Harmony v3 drivers support Asynchronous and Synchronous modes of operation. | Asynchronous Mode . | Non-blocking Application Program Interfaces (APIs) | Works seamlessly in bare-metal and RTOS environment | Interrupt and thread-safe | . | Synchronous Mode . | Blocking APIs | Suitable for use in RTOS environment | Interrupt and thread-safe | . | . In this tutorial, you will use Harmony drivers in Synchronous mode of operation. The application makes use of SAM E70 Xplained Ultra Evaluation Kit and I/O1 Xplained Pro Extension Kit (sold separately). The application reads the current room temperature from the temperature sensor on the I/O1 Xplained Pro Extension Kit. The temperature reading is displayed on a serial console periodically every second. Further, the application writes the temperature readings to EEPROM. When a character is entered on the console, the last five written temperature values are read from the EEPROM and displayed on the console. Also, an LED (LED3) is toggled every time the temperature is displayed on the serial console. The application you create will utilize: . | Two-Wire Interface High Speed (TWIHS) (I²C) Synchronous Driver to read the temperature from a temperature sensor and store/retrieve to/from EEPROM. | USART Synchronous Driver to print the temperature values on a COM (serial) port terminal application running on a PC. | PORTS Peripheral Library to toggle an LED. | FreeRTOS library to create application threads and intercommunicate between application threads. | . For more information refer the links below. ",
    ...
    "content": ". | Arm TrustZone Getting Started Application on PIC32CK SG01 (Cortex-M33) MCUs . | Low Power Application on PIC32CM LE00 (Cortex M23) MCUs Using MPLAB Harmony v3 Peripheral Libraries . | Getting Started with Harmony v3 Peripheral Libraries on SAMC2x MCUs . | Getting Started with Harmony v3 Peripheral Libraries on SAM D5x/E5x MCUs . | Getting Started with Harmony v3 Peripheral Libraries on SAM E70/S70/V70/V71 MCUs . | Getting Started with Harmony v3 Peripheral Libraries on SAM L10 MCUs . | Getting Started with Harmony v3 Peripheral Libraries on SAM D21 MCUs . | Getting Started with Harmony v3 Peripheral Libraries on PIC32MZ EF MCUs . | Getting Started with Harmony v3 Peripheral Libraries on PIC32MX 470 MCUs . | Getting Started with Harmony v3 Peripheral Libraries on PIC32MK GP MCUs . | Low Power Application on SAMC2x (Cortex M0+) MCUs Using MPLAB Harmony v3 Peripheral Libraries . | Low Power Application on SAM L21 (Cortex M0+) MCUs using MPLAB Harmony v3 Peripheral Libraries . | Low Power Application on SAM L10 (Cortex M23) MCUs Using MPLAB Harmony v3 Peripheral Libraries . | Low Power Application on SAM E54 (Cortex M4) MCU Using MPLAB Harmony v3 Peripheral Libraries . | Arm TrustZone Getting Started Application on SAM L11 MCUs . | Low Power Application on SAM D21 (Cortex M0+) MCU Using MPLAB Harmony v3 Peripheral Libraries . | Getting Started with Harmony v3 Peripheral Libraries on SAM9X60 MPUs . | Getting Started with Harmony v3 Peripheral Libraries on SAMA5D29 MPUs . | Getting Started with Harmony v3 Peripheral Libraries on SAMA7G54 MPUs . | . ",
    ...
    "doc": "Peripheral Libraries",
    "title": "Drivers",
    "content": ". | Getting Started with Harmony v3 Drivers and System Services on SAM E70/S70/V70/V71 MCUs . | Getting Started with Harmony v3 Drivers on SAM E70/S70/V70/V71 MCUs using FreeRTOS . | Getting Started with Harmony v3 Drivers on SAM D21 MCUs Using FreeRTOS . | Getting Started with Harmony v3 Drivers on SAM E5x MCUs Using FreeRTOS . | Getting Started with Harmony v3 Drivers on SAM C2x MCUs Using FreeRTOS . | Getting Started with Harmony v3 Drivers on SAM C2x MCUs Using FreeRTOS . | . ",
    "url": "http://localhost:4000/quick_docs/source/peripheral/readme.html#drivers",
    "relUrl": "/source/peripheral/readme.html#drivers"
  },"681": {
    "doc": "Peripheral Libraries",
    "title": "Web Links",
    "content": ". | Clock System Configuration and Usage on SAM E5x (Cortex M4) Devices | Clock System Configuration and Usage on SAM C2x (Cortex M0+) Devices | How to Build an Application by Adding a New PLIB, Driver, or Middleware to an Existing MPLAB Harmony v3 Project | Various Timers on SAM Devices | How to Use the TCM on A Cortex-M7 Based MCU with the XC32 Compiler | How to Create Non-Cacheable Memory Region on CortexM7 (SAM S70/ E70/ V70/ V71) MCUs Using MPLAB Harmony v3 | SleepWalking with Event System Using the SAM E54 | Execute-In-Place (XIP) with QSPI on Cortex-M7 MCUs Using MPLAB Harmony v3 | Using XDMAC with QSPI on Arm Cortex-M7 MCUs Using MPLAB Harmony v3 | How to Wake-up Fast From an External Event on Cortex M0+ Based MCUs | Using Sigma-Delta Analog-to-Digital Converter (SDADC) on a SAMC MCU with MPLAB Harmony v3 | Live Update Application on PIC32MZ MCUs Using MPLAB Harmony v3 | Live Update Application on SAM E54 MCU Using MPLAB Harmony v3 | Dual Bank Bootloader on SAM E54 Microcontroller (MCU) Using MPLAB Harmony v3 | Handling Cache Coherency Issues at Runtime Using Cache Maintenance Operations on Cortex-M7 MCUs Using MPLAB Harmony v3 | Multiplexed and Remappable Functionalities on I/O pins on PIC32M Devices Using MPLAB Harmony v3 | How to Move an Application into a Desired Flash Memory Location with the Help of Linker Script on SAM E54 | AES Cipher Modes Using MPLAB Harmony v3 for the SAM E54 | Dual Developer Application Development Use Case with TrustZone on SAM L11 Using MPLAB Harmony v3 | 32-bit Microcontroller Wafer-Level Chip-Scale Package (WLCSP) | Handling Cache Coherency Issues at Runtime Using Cache Maintenance Operations on PIC32MZ MCUs Using MPLAB Harmony v3 | Watchdog Timer (WDT) on ATSAM E70/S70/V70/V71 Devices Using MPLAB Harmony v3 | Peripheral Power Consumption in Standby Mode for SAM L10/L11 Family of Devices | How to Perform ADC Conversions with DMA Data Transfers on PIC32MK Devices Using MPLAB Harmony v3 | External Memory on SAM E70/S70/V70/V71 MCUs | How to Use the MPLAB Data Visualizer with 32-bit MCU-based Curiosity Nano Evaluation Kits | . ",
    ...
    "doc": "Release notes",
    "title": "Quick Docs Release v1.7.0 (Jun 2024)",
    "content": "New Doc Pages . The following table provides the list of new doc pages: . | Doc Name | Doc Type - Content | . | Create a first application on PIC32CM JH01 Microcontrollers using MPLAB Harmony v3 with MCC | Basic - Full | . | Create a first application on PIC32CM LSx Microcontrollers using MPLAB Harmony v3 with MCC | Basic - Full | . | Create a first application on PIC32CX SG Microcontrollers using MPLAB Harmony v3 with MCC | Basic - Full | . | Create a first application on PIC32CZ CAx Microcontrollers using MPLAB Harmony v3 with MCC | Basic - Full | . | Arm TrustZone Getting Started Application on PIC32CK SG01 (Cortex-M33) MCUs | Peripheral - Full | . | Low Power Application on PIC32CM LE00 (Cortex M23) MCUs Using MPLAB Harmony v3 Peripheral Libraries | Peripheral - Full | . Updated Doc Pages . | Doc Name | Doc Type - Content | Comments | . | MPLAB® Code Configurator Overview with MPLAB Harmony Content | Basic - Full | Updated new links and steps | . | MPLAB Code Configurator (MCC) for Harmony 3 Projects | Basic - Full | Updated new links and steps | . | Create a new MPLAB Harmony v3 project using MCC | Basic - Full | Updated new links and steps | . | Update and Configure an Existing MHC-based MPLAB Harmony v3 Project to MCC-based Project | Basic - Full | Updated new links and steps | . | Create First MPLAB Harmony 3 Project | Basic - Full | Updated new links and steps | . | Create “Hello World” application on SAM MCUs | Basic - Full | Migrated from MHC to MCC | . | Create “Hello World” application on PIC MCUs | Basic - Full | Updated new links and steps | . | Create IAR or Keil project using MCC | Basic - Full | Updated new links and steps | . | Create new TrustZone Project | Basic - Full | Updated new links and steps | . | Configure at91bootstrap Second Stage Bootloader to enable QSPI XIP on MPUs | Basic - Full | Updated new links and steps | . | SAM9X60 Configure First Stage Bootloader | Basic - Full | Updated new links and steps | . | Configure the second stage bootloader for SAM9X60 based MPUs | Basic - Full | Updated new links and steps | . | SAM9X60 Flash boot and harmony application binaries using SAMBA | Basic - Full | Updated tools version and images | . | Getting started with SAM9X60 Curiosity Development Board using MPLAB Harmony 3 | Basic - Full | Updated tools version and images | . | Developing an application getting executed from QSPI flash on SAM9X60-EK | Basic - Full | Updated tools version | . | SAMA7G54 Configure First Stage Bootloader | Basic - Full | Updated new links and steps | . | Configure the second stage bootloader for SAMA7G54 based MPUs | Basic - Full | Updated at91bootstrap version | . | Create first Audio Application | Middleware - Full | Updated new links and steps | . | Create first Audio Decoder Application | Middleware - Full | Updated new links and steps | . | MPLAB Harmony 3 Audio Overview | Middleware - Full | Updated new links and steps | . | Secure Boot on PIC32CM LS60 Curiosity Pro Evaluation Kit using MPLAB Harmony v3 | Middleware - Full | Updated new links and steps | . | Digit Recognition AI/ML Application on SAM E51 IGAT CURIOSITY EVALUATION KIT Using MPLAB Harmony v3 | Middleware - Full | Updated new links and steps | . | Getting Started with Middleware on PIC32MZ EF MCUs | Middleware - Full | Migrated from MHC to MCC and updated links | . | Rapid prototyping with Curiosity Nano Evaluation Kit using MPLAB Harmony v3 | Middleware - Full | Migrated from MHC to MCC and updated links | . | Getting Started with USB on SAM MCUs Using MPLAB Harmony v3 | Middleware - Full | Migrated from MHC to MCC and updated links | . | MPLAB® Harmony v3 SD Card Audio Player/Reader Tutorial | Middleware - Full | Migrated from MHC to MCC and updated links | . | Getting Started with MPLAB Harmony v3 to Create a Web-Enabled Digital Photo Frame | Middleware - Full | Updated new links and steps | . | Application migration from 8-bit AVR to 32-bit SAM D21 MCU | Migration - Full | Updated new links and steps | . | Build MPLAB Harmony v3 project with ARM GCC toolchain in MPLAB X IDE | Migration - Full | Updated new links and steps | . | Migration from MC | Migration - Full | Updated new links and steps | . | MPLAB Harmony v3 Project Migration | Migration - Full | Updated new links and steps | . | Application migration from 8-bit PIC18F to 32-bit SAM D21 MCU | Migration - Full | Updated new links and steps | . | Migrating ASF SAM C21 Application to MPLAB Harmony v3 PIC32CM MC | Migration - Full | Migrated from MHC to MCC and updated links | . | Migrating a MPLAB Harmony 3 Application from the SAM9X60 EK to SAM9X60 Curiosity | Migration - Full | Migrated from MHC to MCC and updated links | . | Arm TrustZone Getting Started Application on SAM L11 MCUs | Peripheral - Full | Updated new links and steps | . | Getting Started with PLIBs on SAM9X60 MPUs | Peripheral - Full | Migrated from MHC to MCC and updated links | . | Getting Started with Drivers on SAM C2x MCUs Using FreeRTOS | Peripheral - Full | Migrated from MHC to MCC and updated links | . | Getting Started with Drivers on SAM C2x MCUs | Peripheral - Full | Migrated from MHC to MCC and updated links | . | Getting Started with Drivers on SAM D21 MCUs Using FreeRTOS | Peripheral - Full | Migrated from MHC to MCC and updated links | . | Low Power with PLIBs on SAM D21 MCUs | Peripheral - Full | Migrated from MHC to MCC and updated links | . | Getting Started with Drivers on SAM E5x MCUs Using FreeRTOS | Peripheral - Full | Updated new links and steps | . | Getting Started with Drivers on SAM E70/S70/V70/V71 MCUs | Peripheral - Full | Migrated from MHC to MCC and updated links | . | Getting Started with Drivers on SAM E70/S70/V70/V71 MCUs using FreeRTOS | Peripheral - Full | Migrated from MHC to MCC and updated links | . | Getting Started with PLIBs on PIC32MK GP MCUs | Peripheral - Full | Migrated from MHC to MCC and updated links | . | Getting Started with PLIBs on PIC32MX 470 MCUs | Peripheral - Full | Migrated from MHC to MCC and updated links | . | Getting Started with PLIBs on PIC32MZ EF MCUs | Peripheral - Full | Migrated from MHC to MCC and updated links | . | Getting Started with PLIBs on SAMC2x MCUs | Peripheral - Full | Updated new links and steps | . | Low Power Application on SAMC2x (Cortex M0+) MCUs Using MPLAB Harmony v3 Peripheral Libraries | Peripheral - Full | Updated new links and steps | . | Getting Started with PLIBs on SAM D5x/E5x MCUs | Peripheral - Full | Migrated from MHC to MCC and updated links | . | Getting Started with PLIBs on SAM D21 MCUs | Peripheral - Full | Migrated from MHC to MCC and updated links | . | Low Power Application on SAM E54 (Cortex M4) MCUs Using MPLAB Harmony v3 Peripheral Libraries | Peripheral - Full | Updated new links and steps | . | Getting Started with PLIBs on SAM E70/S70/V70/V71 MCUs | Peripheral - Full | Migrated from MHC to MCC and updated links | . | Getting Started with PLIBs on SAM L10 MCUs | Peripheral - Full | Migrated from MHC to MCC and updated links | . | Low Power Application on SAM L10 (Cortex M23) MCUs Using MPLAB Harmony v3 Peripheral Libraries | Peripheral - Full | Updated new links and steps | . | Low Power Application on SAM L21 (Cortex M0+) MCUs Using MPLAB Harmony v3 Peripheral Libraries | Peripheral - Full | Updated new links and steps | . | Getting Started with PLIBs on SAM9X60 MPUs | Peripheral - Full | Updated new links and steps | . | Getting Started with PLIBs on SAMA5D29 MPUs | Peripheral - Full | Updated new links and steps | . | Getting Started with PLIBs on SAMA7G54 MPUs | Peripheral - Full | Updated new links and steps | . | New Weblinks and Video added in Basic page | New Weblinks and Video added in Peripheral page | New Weblinks and Video added in Middleware page | . Development Tools . | MPLAB® X IDE v6.20 or higher | MPLAB® XC32 C/C++ Compiler v4.40 | MPLAB® X IDE plug-ins: . | MPLAB® Code Configurator 5.5.1 or higher | . | . Known Issues . - NA - . ",
    "url": "http://localhost:4000/quick_docs/release_notes.html#quick-docs-release-v170-jun-2024",
    "relUrl": "/release_notes.html#quick-docs-release-v170-jun-2024"
  },"692": {
    "doc": "Release notes",
    "title": "Quick Docs Release v1.6.0 (Sep 2023)",
    "content": "New Doc Pages . The following table provides the list of new doc pages: . | Doc Name | Doc Type - Content | . | MPLAB Code Configurator Overview with MPLAB Harmony Content | Basic - Brief Overview and Web link | . | MPLAB Code Configurator Options | Basic - Full | . | Getting Started with MPLAB Harmony v3 to Create a Web-Enabled Digital Photo Frame | Middleware - Brief Overview and Web link | . | Secure Boot on PIC32CM LS60 Curiosity Pro Evaluation Kit using MPLAB Harmony v3 | Middleware - Brief Overview and Web link | . | File Transfer Protocol Using MPLAB Harmony v3 TCP/IP Stack for SAM E54 MCU | Middleware - Brief Overview and Web link | . | Develop a harmony based application for SAM9X60 MPU using MPLAB® X IDE | Basic - Full | . | Configure first stage bootloader for SAM9X60 MPU | Basic - Full | . | Configure/built and debug second stage bootloader(at91bootstrap) for SAM9X60 MPU | Basic - Full | . | Flash the at91bootstrap and harmony application binaries using SAM-BA tool | Basic - Full | . | Configure at91bootstrap to enable QSPI-XIP on MPUs | Basic - Full | . | Develop a harmony based application executed from QSPI for SAM9X60 MPU using MPLAB® X IDE | Basic - Full | . | Configure first stage bootloader for SAMA7G5 MPU | Basic - Full | . | Configure/built and debug second stage bootloader(at91bootstrap) for SAMA7G5 MPU | Basic - Full | . | SAM-BA installation and initialization for SAMA7G5 MPU | Basic - Full | . | Flash the at91bootstrap and harmony application binaries of SAMA7G5 MPU using SAM-BA tool | Basic - Full | . | Migrating SAM9X60-EK Harmony Application to SAM9X60 Curiosity Development Board | Migration - Brief Overview and Web link | . | Getting Started with Harmony v3 Peripheral Libraries on SAM9X60 MPUs | Peripheral - Brief Overview and Web link | . Updated Doc Pages . | Doc Name | Doc Type - Content | Comments | . | Create First MPLAB Harmony 3 Project | Basic - Full | Migrated from MHC to MCC | . | Create Hello World application on SAM MCUs | Basic - Full | Migrated from MHC to MCC | . | MCC Clock Configuration | Basic - Full | Migrated from MHC to MCC | . | MCC Pin Configuration | Basic - Full | Migrated from MHC to MCC | . | MCC NVIC Configuration | Basic - Full | Migrated from MHC to MCC | . | MCC Project Graph | Basic - Full | Migrated from MHC to MCC | . | MCC DMA Configuration | Basic - Full | Migrated from MHC to MCC | . | MCC Memory protection Unit Configuration | Basic - Full | Migrated from MHC to MCC | . | MCC Code Generation | Basic - Full | Migrated from MHC to MCC | . | Create Hello World application on PIC MCUs | Basic - Full | Migrated from MHC to MCC | . | Creating an IAR or KEIL project using MCC | Basic - Full | Migrated from MHC to MCC | . | Creating a New TrustZone Project | Basic - Full | Migrated from MHC to MCC | . Deleted Doc Pages . | Doc Name | Doc Type - Content | Comments | . | Getting started with SAM MPUs using MPLAB Harmony 3 | Full | Deleted this document as new alternative pages created | . | MPLAB Harmony 3 Configurator (MHC) | Full | Deleted this document as UI is migrated from MHC and an alternative page for the same on MCC is available | . | Open an Existing Harmony 3 Project | Full | Deleted this document as UI is migrated from MHC and an alternative page for the same on MCC is available | . | MHC Window Manager and Log Level | Full | Deleted this document as UI is migrated from MHC to MCC and no corresponding pages exist in MCC | . | Harmony 3 Packages | Full | Deleted this document. Refer to https://github.com/Microchip-MPLAB-Harmony for the list of packages | . | New Weblink added in Basic page | New Weblink added in Peripheral page | New video Weblinks added in Middleware page | New video Weblinks added in Peripheral page | . Known Issues . - NA - . ",
    "url": "http://localhost:4000/quick_docs/release_notes.html#quick-docs-release-v160-sep-2023",
    "relUrl": "/release_notes.html#quick-docs-release-v160-sep-2023"
  },"693": {
    "doc": "Release notes",
