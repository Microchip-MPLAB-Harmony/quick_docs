...
{"0": {
    ...
    "doc": "Create First Harmony 3 Project",
    "title": "Note",
    "content": "This page has been verified with the following versions of software tools: . | MPLAB Harmony v3 “csp” repo v3.10.0 | MPLAB Harmony v3 “dev_packs” repo v3.10.0 | MPLAB Harmony v3 “mhc” repo v3.8.2 | MPLAB Harmony 3 Launcher Plugin v3.6.4 | MPLAB X IDE v5.50 | MPLAB XC32 Compiler v3.01 | . Because Microchip regularly update tools, occasionally there could be minor differences with the newer versions of the tools. ",
    ...
    "doc": "Build MPLAB Harmony v3 project with ARM GCC toolchain in MPLAB X IDE",
    "title": "Software/Tools Used:",
    "content": "This project has been verified to work with the following versions of software tools: . | MPLAB Harmony v3 “csp” repo v3.10.0 | MPLAB Harmony v3 “csp_apps_sam_d21_da1” repo v3.2.0 | MPLAB Harmony v3 “dev_packs” repo v3.10.0 | MPLAB Harmony v3 “mhc” repo v3.8.2 | MPLAB Harmony 3 Launcher Plugin v3.6.4 | MPLAB X IDE v5.50 | ARM GNU Toolchain v6.3.1 | MPLAB XC32 Compiler v3.01 | Any Serial Terminal application like Tera Term terminal application. | . Because Microchip regularly update tools, occasionally issue(s) could be discovered while using the newer versions of the tools. If the project doesn’t seem to work and version incompatibility is suspected, It is recommended to double-check and use the same versions that the project was tested with. ",
