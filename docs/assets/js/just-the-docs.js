...
{"0": {
    ...
    "content": ". | Open the MPLAB® X IDE. | Create a New Project by clicking the New Project icon or by selecting File &gt; New Project. | In the New Project window select 32-Bit MCC Harmony Project. | Click Next. Note: If the option 32-Bit MPLAB Harmony v3 Project is not available, install the MPLAB® Harmony 3 Launcher plug-in from Tools &gt; Plugins &gt; Available Plugins before continuing with this demonstration. | Enter the path to the folder in which you downloaded the MPLAB® Harmony 3 packages in the Framework Path edit box. | In the Project Setting dialog window, fill in or select the information needed as follows: . | Location: Create a “MyProject_blink” folder in the location of your choice. | Folder: Project Folder name i.e. “sam_c21n_xpro” | Name: Project Name i.e. “my_blinky_sam_c21n_xpro” | . | In the Configuration Settings dialog window, enter the configuration name as “sam_c21n_xpro” and select the Target Device ATSAMC21N18A from the drop-down menu as shown below. | Click Finish. | While the MCC tool launches, Click on Select MPLAB Harmony content type. Click on the Finish Button in the MCC Content Manager Wizard. | . ",
    ...
    "doc": "Create First Harmony 3 Project",
    "title": "Note",
    "content": "This page has been verified with the following versions of software tools: . | MPLAB X IDE v6.15 | MPLAB XC32 Compiler v4.30 | MPLAB Code Configurator v5.3.7 | MCC Harmony v1.3.2 | MPLAB Harmony v3 “csp” repo v3.18.0 | MPLAB Harmony v3 “dev_packs” repo v3.18.0 | . Because Microchip regularly update tools, occasionally there could be minor differences with the newer versions of the tools. ",
    ...
    "doc": "Create IAR or Keil project using MCC",
    "title": "Note",
    "content": "This page has been verified with the following versions of software tools: . | MPLAB Harmony v3 “csp” repo v3.17.0 | MPLAB Harmony v3 “dev_packs” repo v3.17.0 | MPLAB Code Configurator [MCC] Standalone v5.3.7 | MPLAB XC32 Compiler v4.30 | . Because Microchip regularly update tools, occasionally there could be minor differences with the newer versions of the tools. ",
    ...
    "content": "To create a new TrustZone project, in MPLAB® X IDE, Select File &gt; New Project or click . The New Project wizard will open. Perform following steps: . | Choose Project: . | In the Choose Project pane, select the Microchip Embedded category. | In the Projects pane, select 32-bit MCC Harmony Project, then click Next. | | . Note: If the 32-bit MCC Harmony Project type is not listed under the Microchip Embedded category, please download and install MPLAB® Code Configurator before continuing with these steps. | Framework Selection: . | Provide the framework path where Harmony 3 repositories have been downloaded, then click Next. | . | . | Project Settings: . | Location: Indicates the path to the root folder of the new project. All project files will be placed in this folder. | Folder: Indicates the name of the MPLAB® X IDE folder. | Name: Enter name of the project which you want to see in MPLAB® X IDE, click Next. | Path: The path information will be updated automatically as and when users make changes to other fields. | | . Note: Click the “Show Visual Help” button to open a contextual help window for a detailed description of various fields in the Project Settings. | Configuration Settings: . | Name: Enter the configuration name. | Target Device: Choose target device | Click Finish button to launch MPLAB® Code Configurator (MCC). After clicking the Finish button, MCC will create Secure and Non-secure MPLAB® X Projects. | . | The MCC plug-in will open inside MPLAB® X window . | . | TrustZone Project uses two projects viz., Secure and Non-Secure Project that work together on the same MCU and offering security isolation between the Trusted and the Non-trusted resources in the device. | Secure Project: . | Secure project contains harmony project file harmony.prj. And this project also contains a configuration file for both Secure and Non-secure project. | Secure project must be selected as Main Project to launch MCC. | Once the Harmony code is generated, Secure user application should be developed in secure “main.c”. | “nonsecure_entry.c” and “nonsecure_entry.h” files should be used for the Non-secure to Secure function calls. | Secure project is a loadable project from the Non-secure project. When Secure Project builds it generates Secure Gateway (SG) library ([configuration name]_Secure_sg_veneer.lib) which will be used by the Non-secure project while building the Non-secure project. | . | Non-secure Project: . | Once the Harmony code is generated, Non-secure user application should be developed in Non-secure “main.c”. | When Non-secure Project builds, it first builds Secure Project and then Non-secure project and generates target binaries to be executed on the device. | . | . | . ",
    ...
    "doc": "MPLAB Code Configurator Overview with MPLAB Harmony Content",
    "title": "Web Links",
    "content": ". | MPLAB Code Configurator Overview with MPLAB Harmony Content | . ",
    ...
    "doc": "Harmony Basics",
    "title": "Web Links",
    "content": ". | 32-bit Microcontroller Collateral and Solutions Reference Guide | How to Get Started with MPLAB Harmony v3 | Create a New MPLAB Harmony v3 Project | How to Set Up MPLAB Harmony v3 Software Development Framework | MPLAB Harmony Content Manager | . ",
    ...
    "doc": "Secure Boot on PIC32CM LS60 Curiosity Pro Evaluation Kit using MPLAB Harmony v3",
    "title": "Web Links",
    "content": ". | Secure Boot on PIC32CM LS60 Curiosity Pro Evaluation Kit using MPLAB Harmony v3e | . ",
