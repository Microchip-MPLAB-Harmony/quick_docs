...
{"0": {
    ...
    "doc": "Create First Harmony 3 Project",
    "title": "Note",
    "content": "This page has been verified with the following versions of software tools: . | MPLAB Harmony v3 “csp” repo v3.9.1 | MPLAB Harmony v3 “dev_packs” repo v3.9.0 | MPLAB Harmony v3 “mhc” repo v3.7.2 | MPLAB Harmony 3 Launcher Plugin v3.6.4 | MPLAB X IDE v5.50 | MPLAB XC32 Compiler v3.00 | . Because Microchip regularly update tools, occasionally there could be minor differences with the newer versions of the tools. ",
    ...
    "title": "Note",
    "content": "This page has been verified with the following versions of software tools: . | MPLAB Harmony v3 “csp” repo v3.8.3 | MPLAB Harmony v3 “dev_packs” repo v3.8.0 | MPLAB Harmony v3 “mhc” repo v3.6.5 | MPLAB Harmony 3 Launcher Plugin v3.6.2 | MPLAB X IDE v5.45 | MPLAB XC32 Compiler v2.41 | . Because Microchip regularly update tools, occasionally there could be minor differences with the newer versions of the tools. ",
    "url": "http://localhost:4000/quick_docs/source/basic/sam_mpus_getting_started_mplabx/readme.html#note-1",
    "relUrl": "/source/basic/sam_mpus_getting_started_mplabx/readme.html#note-1"
  },"144": {
    "doc": "Getting started with SAM MPU Devices on MPLAB X Tools",
    "title": "Reference Links",
    "content": "                . ",
    ...
    "content": "This page contains quick documentation for MPLAB® Harmony 3 Middleware Libraries usage. | Getting Started with Harmony v3 Drivers and Middleware on PIC32MZ EF MCUs using FreeRTOS . | Getting Started with USB on SAM MCUs Using MPLAB Harmony v3 . | Rapid prototyping with Curiosity Nano Evaluation Kit using MPLAB Harmony v3 . | . ",
    ...
    "doc": "Build MPLAB Harmony v3 project with ARM GCC toolchain in MPLAB X IDE",
    "title": "Software/Tools Used:",
    "content": "This project has been verified to work with the following versions of software tools: . | MPLAB Harmony v3 “csp” repo v3.9.1 | MPLAB Harmony v3 “csp_apps_sam_d21_da1” repo v3.1.0 | MPLAB Harmony v3 “dev_packs” repo v3.9.0 | MPLAB Harmony v3 “mhc” repo v3.7.2 | MPLAB Harmony 3 Launcher Plugin v3.6.4 | MPLAB X IDE v5.50 | ARM GNU Toolchain v6.3.1 | MPLAB XC32 Compiler v3.00 | Any Serial Terminal application like Tera Term terminal application. | . Because Microchip regularly update tools, occasionally issue(s) could be discovered while using the newer versions of the tools. If the project doesn’t seem to work and version incompatibility is suspected, It is recommended to double-check and use the same versions that the project was tested with. ",
    ...
    "content": "New Doc Pages . The following table provides the list of new doc pages: . | Doc Name | Doc Type - Content | . | Create a new MPLAB Harmony v3 project using MCC | Basic - Brief Overview and Web link | . | Update and Configure an Existing MHC-based MPLAB Harmony v3 Project to MCC-based Project | Basic - Brief Overview and Web link | . | Low Power Application on SAM D21 (Cortex M0+) MCU Using MPLAB Harmony v3 Peripheral Libraries | Peripheral - Brief Overview and Web link | . | Rapid prototyping with Curiosity Nano Evaluation Kit using MPLAB Harmony v3 | Middleware - Brief Overview and Web link | . | Add a New Configuration to an Existing MPLAB Harmony v3 Project | Basic - Brief Overview and Web link | . | MPLAB Harmony v3 Project Manifest Feature | Basic - Brief Overview and Web link | . | New Weblink added in Peripheral page | New Weblink added in Middleware page | New video Weblinks added in Basic page | New video Weblinks added in Middleware page | . Known Issues . - NA - . ",
