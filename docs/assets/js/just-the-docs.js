...
{"0": {
    ...
    "title": "Note",
    "content": "This page has been verified with the following versions of software tools: . | MPLAB Harmony v3 “csp” repo v3.10.0 | MPLAB Harmony v3 “dev_packs” repo v3.10.0 | MPLAB Harmony v3 “mhc” repo v3.8.2 | MPLAB Harmony 3 Launcher Plugin v3.6.4 | MPLAB X IDE v5.50 | MPLAB XC32 Compiler v3.01 | . Because Microchip regularly update tools, occasionally there could be minor differences with the newer versions of the tools. ",
    "url": "http://localhost:4000/quick_docs/source/basic/mplab_harmony_3_code_configurator/readme.html#note",
    "relUrl": "/source/basic/mplab_harmony_3_code_configurator/readme.html#note"
  },"124": {
    "doc": "MPLAB Code Configurator (MCC) for Harmony 3 Projects",
    "title": "Reference Links",
    "content": "                . ",
    ...
    "content": "New Doc Pages . The following table provides the list of new doc pages: . | Doc Name | Doc Type - Content | . | MPLAB Harmony v3 Project Migration | Migration - Brief Overview and Web link | . | Digit Recognition AI/ML Application on SAM E51 IGAT CURIOSITY EVALUATION KIT Using MPLAB Harmony v3 | Middleware - Brief Overview and Web link | . | MPLAB Code Configurator (MCC) for Harmony 3 Projects | Basic - Brief Overview and Web link | . | New Weblink added in Peripheral page | New Weblink added in Middleware page | New video Weblinks added in Basic page | New video Weblinks added in Middleware page | . Known Issues . - NA - . ",
