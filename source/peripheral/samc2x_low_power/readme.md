...
The application makes use of the <a href="https://www.microchip.com/en-us/development-tool/atsamc21-xpro" target="_blank">SAM C21 Xplained Pro evaluation kit</a>
...
- <a href="https://developerhelp.microchip.com/xwiki/bin/view/software-tools/harmony/low-power-application-on-samc21/" target="_blank">Low Power Application on SAMC2x (Cortex M0+) MCUs Using MPLAB Harmony v3 Peripheral Libraries</a>
