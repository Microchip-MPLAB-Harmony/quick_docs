...
This tutorial shows you how to use the MPLAB Code Configurator (MCC) to create an application that gets you started on developing applications on SAM E70/S70/V70/V71 MCUs using the MPLAB Harmony v3 software framework.
...
- <a href="https://developerhelp.microchip.com/xwiki/bin/view/software-tools/harmony/archive/same70-getting-started-training-module-drivers/" target="_blank">Getting Started with Harmony v3 Drivers and System Services on SAM E70/S70/V70/V71 MCUs</a>
