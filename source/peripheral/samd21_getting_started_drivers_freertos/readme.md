...
This tutorial shows you how to use [MCC](https://developerhelp.microchip.com/xwiki/bin/view/software-tools/harmony/archive/mcc-overview/) to create an application that gets you started in developing applications on SAM D21 MCUs using the MPLAB Harmony v3 software framework with FreeRTOS.
...
The application makes use of the [SAM D21 Xplained Pro Evaluation Kit](https://www.microchip.com/en-us/development-tool/ATSAMD21-XPRO) and [I/O1 Xplained Pro Extension Kit](https://www.microchip.com/en-us/development-tool/atio1-xpro) (sold separately).
...
- <a href="https://developerhelp.microchip.com/xwiki/bin/view/software-tools/harmony/samd21-getting-started-tm-drivers-freertos/" target="_blank">Getting Started with MPLAB® Harmony v3 Drivers on SAM D21 MCUs Using FreeRTOS</a>
