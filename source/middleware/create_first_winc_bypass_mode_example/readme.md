...
- <a href="https://github.com/Microchip-MPLAB-Harmony/wireless/wiki/Create-your-first-winc-bypass-application" target="_blank">Create your first WIN1500 Bypass mode example using Harmony TCP/IP stack</a>
