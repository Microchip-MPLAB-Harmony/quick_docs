...
<a id="Install-MCC"> </a>
### Install MCC
1.	Install the MPLAB® Code Configurator (MCC) Plug-in in the MPLAB X IDE if not installed.
2.	Verify the MPLAB® Code Configurator (MCC) Plug-in is installed.
...
### Build and Program
9.	Before proceeding to Build and program, set up the compiler toolchain. Click on the **Projects** tab on the top left pane in MPLAB X IDE. Right click on the project name **atmega4809_to_sam_d21_cnano** and go to **Properties**.  
...
36.	Launch **DMA Configuration** from **Project Graph > Plugins > DMA Configuration**.  
   <img src = "images/dma_launch.png" width="500" height="300" align="middle">  
37.	Click on **ADD Channel** and Select **SERCOM5_Transmit** to configure the DMA  
