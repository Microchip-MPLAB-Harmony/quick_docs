...
This guide will show you how to install the MPLAB® Code Configurator (MCC) plugin and how to download MPLAB Harmony framework. It also provides a brief overview of the MCC user interface.
...
- <a href="https://developerhelp.microchip.com/xwiki/bin/view/software-tools/mcc/" target="_blank">MPLAB Code Configurator Overview with MPLAB Harmony Content </a>
