...
The instructions in this tutorial use [SAMD21 Xplained Pro board](https://www.microchip.com/DevelopmentTools/ProductDetails/ATSAMD21-XPRO) and it has one Yellow Color user LED (PB30) connected GPIO. Similar kits will work similarly, but the setup and steps may not be exactly as described.
...
Harmony v3 packages. If these packages are not downloaded, then the user can use the [MPLAB Harmony 3
Content Manager](https://github.com/Microchip-MPLAB-Harmony/contentmanager/wiki/) tool to download them onto their computer.
